...
void* Sig_UBlueprintMapLibrary_ExecMap_Add = sigScan(
	"\x40\x55\x41\x54\x41\x55\x41\x56\x41\x57\x48\x81\xEC\xB0\x00\x00\x00\x48\x8D\x6C\x24\x2A\x48\x89\x9D\x2A\x2A\x2A\x2A\x48\x89\xB5\x2A\x2A\x2A\x2A\x48\x89\xBD\x2A\x2A\x2A\x2A\x48\x8B\x05\x2A\x2A\x2A\x2A\x48\x33\xC5\x48\x89\x85\x2A\x2A\x2A\x2A",
	"xxxxxxxxxxxxxxxxxxxxx?xxx????xxx????xxx????xxx????xxxxxx????");

FUNCTION_PTR(void, __fastcall, TArray_ResizeTo, Sig_TArray_ResizeTo, void* TargetArray, int Size);
FUNCTION_PTR(void, __fastcall, UBlueprintMapLibrary_ExecMap_Add, Sig_UBlueprintMapLibrary_ExecMap_Add, uint64_t* TargetMap);
