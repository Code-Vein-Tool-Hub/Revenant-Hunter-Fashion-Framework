...
// Function NiagaraAnimNotifies.AnimNotifyState_TrailNiagaraEffect.GetSpawnedEffect
// 0x0010 (0x0010 - 0x0000)
struct AnimNotifyState_TrailNiagaraEffect_GetSpawnedEffect final
{
public:
...
static_assert(alignof(AnimNotifyState_TrailNiagaraEffect_GetSpawnedEffect) == 0x000008, "Wrong alignment on AnimNotifyState_TrailNiagaraEffect_GetSpawnedEffect");
static_assert(sizeof(AnimNotifyState_TrailNiagaraEffect_GetSpawnedEffect) == 0x000010, "Wrong size on AnimNotifyState_TrailNiagaraEffect_GetSpawnedEffect");
static_assert(offsetof(AnimNotifyState_TrailNiagaraEffect_GetSpawnedEffect, MeshComp) == 0x000000, "Member 'AnimNotifyState_TrailNiagaraEffect_GetSpawnedEffect::MeshComp' has a wrong offset!");
static_assert(offsetof(AnimNotifyState_TrailNiagaraEffect_GetSpawnedEffect, ReturnValue) == 0x000008, "Member 'AnimNotifyState_TrailNiagaraEffect_GetSpawnedEffect::ReturnValue' has a wrong offset!");
