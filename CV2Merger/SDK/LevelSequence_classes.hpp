...
public:
	...
	TSubclassOf<class UObject>                    DirectorClass;                                     // 0x0090(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UAssetUserData*>                 AssetUserData;                                     // 0x0098(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, AdvancedDisplay, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ULevelSequence) == 0x0000A8, "Wrong size on ULevelSequence");
static_assert(offsetof(ULevelSequence, MovieScene) == 0x000078, "Member 'ULevelSequence::MovieScene' has a wrong offset!");
static_assert(offsetof(ULevelSequence, BindingReferences) == 0x000080, "Member 'ULevelSequence::BindingReferences' has a wrong offset!");
static_assert(offsetof(ULevelSequence, DirectorClass) == 0x000090, "Member 'ULevelSequence::DirectorClass' has a wrong offset!");
static_assert(offsetof(ULevelSequence, AssetUserData) == 0x000098, "Member 'ULevelSequence::AssetUserData' has a wrong offset!");
...
public:
	...
	class ALevelSequenceActor*                    LevelSequenceActor;                                // 0x03C0(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(ULevelSequenceBurnIn, FrameInformation) == 0x0002F8, "Member 'ULevelSequenceBurnIn::FrameInformation' has a wrong offset!");
