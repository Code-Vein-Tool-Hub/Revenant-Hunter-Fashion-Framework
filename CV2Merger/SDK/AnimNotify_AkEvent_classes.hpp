...
public:
	...
	struct FGameplayTag                           ConditionTag;                                      // 0x0068(0x0008)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash)
	bool                                          NotCondition;                                      // 0x0070(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UAnimNotify_AkEvent_C) == 0x000078, "Wrong size on UAnimNotify_AkEvent_C");
...
static_assert(offsetof(UAnimNotify_AkEvent_C, ConditionTag) == 0x000068, "Member 'UAnimNotify_AkEvent_C::ConditionTag' has a wrong offset!");
static_assert(offsetof(UAnimNotify_AkEvent_C, NotCondition) == 0x000070, "Member 'UAnimNotify_AkEvent_C::NotCondition' has a wrong offset!");
