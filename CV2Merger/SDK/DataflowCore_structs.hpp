...
{
public:
	class FName                                   Key;                                               // 0x00F0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 Default;                                           // 0x00F8(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IsOverriden;                                       // 0x0108(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_109[0x7];                                      // 0x0109(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FDataflowOverrideNode) == 0x000008, "Wrong alignment on FDataflowOverrideNode");
static_assert(sizeof(FDataflowOverrideNode) == 0x000110, "Wrong size on FDataflowOverrideNode");
static_assert(offsetof(FDataflowOverrideNode, Key) == 0x0000F0, "Member 'FDataflowOverrideNode::Key' has a wrong offset!");
static_assert(offsetof(FDataflowOverrideNode, Default) == 0x0000F8, "Member 'FDataflowOverrideNode::Default' has a wrong offset!");
static_assert(offsetof(FDataflowOverrideNode, IsOverriden) == 0x000108, "Member 'FDataflowOverrideNode::IsOverriden' has a wrong offset!");
