...
static_assert(sizeof(URigVM) == 0x000398, "Wrong size on URigVM");
...
static_assert(sizeof(URigVMNativized) == 0x0003C0, "Wrong size on URigVMNativized");
...
public:
	...
	uint8                                         Pad_198[0xA0];                                     // 0x0198(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(URigVMHost) == 0x000288, "Wrong size on URigVMHost");
...
static_assert(offsetof(URigVMHost, AssetUserData) == 0x000238, "Member 'URigVMHost::AssetUserData' has a wrong offset!");
