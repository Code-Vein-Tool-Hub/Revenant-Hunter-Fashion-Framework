...
static_assert(sizeof(FMovieSceneConstraintChannel) == 0x000120, "Wrong size on FMovieSceneConstraintChannel");
...
public:
	...
	class UTickableConstraint*                    ConstraintCopyToSpawn;                             // 0x0120(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FConstraintAndActiveChannel) == 0x000008, "Wrong alignment on FConstraintAndActiveChannel");
static_assert(sizeof(FConstraintAndActiveChannel) == 0x000128, "Wrong size on FConstraintAndActiveChannel");
...
static_assert(offsetof(FConstraintAndActiveChannel, ConstraintCopyToSpawn) == 0x000120, "Member 'FConstraintAndActiveChannel::ConstraintCopyToSpawn' has a wrong offset!");
