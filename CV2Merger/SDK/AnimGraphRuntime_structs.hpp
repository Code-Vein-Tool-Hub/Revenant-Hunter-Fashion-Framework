...
// 0x0470 (0x0CA0 - 0x0830)
struct FAnimSequencerInstanceProxy final : public FAnimInstanceProxy
{
public:
	uint8                                         Pad_830[0x470];                                    // 0x0830(0x0470)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimSequencerInstanceProxy) == 0x000010, "Wrong alignment on FAnimSequencerInstanceProxy");
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x000CA0, "Wrong size on FAnimSequencerInstanceProxy");
...
public:
	...
	uint8                                         Pad_30E[0x682];                                    // 0x030E(0x0682)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
