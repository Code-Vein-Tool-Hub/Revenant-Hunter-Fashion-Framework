...
static_assert(alignof(DLSSLibrary_IsRayTracingAvailable) == 0x000001, "Wrong alignment on DLSSLibrary_IsRayTracingAvailable");
static_assert(sizeof(DLSSLibrary_IsRayTracingAvailable) == 0x000001, "Wrong size on DLSSLibrary_IsRayTracingAvailable");
static_assert(offsetof(DLSSLibrary_IsRayTracingAvailable, ReturnValue) == 0x000000, "Member 'DLSSLibrary_IsRayTracingAvailable::ReturnValue' has a wrong offset!");
