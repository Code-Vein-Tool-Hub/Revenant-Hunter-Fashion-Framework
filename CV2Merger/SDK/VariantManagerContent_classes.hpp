...
public:
	...
	TArray<TFieldPath<struct FProperty>>          Properties;                                        // 0x0098(0x0010)(ZeroConstructor, Deprecated, Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UPropertyValue, Properties) == 0x000098, "Member 'UPropertyValue::Properties' has a wrong offset!");
static_assert(offsetof(UPropertyValue, PropertyIndices) == 0x0000A8, "Member 'UPropertyValue::PropertyIndices' has a wrong offset!");
static_assert(offsetof(UPropertyValue, CapturedPropSegments) == 0x0000B8, "Member 'UPropertyValue::CapturedPropSegments' has a wrong offset!");
static_assert(offsetof(UPropertyValue, FullDisplayString) == 0x0000C8, "Member 'UPropertyValue::FullDisplayString' has a wrong offset!");
static_assert(offsetof(UPropertyValue, PropertySetterName) == 0x0000D8, "Member 'UPropertyValue::PropertySetterName' has a wrong offset!");
