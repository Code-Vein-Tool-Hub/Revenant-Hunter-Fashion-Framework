...
// Enum PCG.EPCGAttributeFromPieces_Mode
// NumValues: 0x0002
enum class EPCGAttributeFromPieces_Mode : uint8
{
	WeightedRandom                           = 0,
	EPCGAttributeFromPieces_MAX              = 1,
};
...
enum class EPCGMetadataMakeRotatorOp : uint8
{
	...
	MakeRotFromAxisAndAngle                  = 11,
	EPCGMetadataMakeRotatorOp_MAX            = 12,
};
...
// Enum PCG.EPCGRotatePointsMode
// NumValues: 0x0002
enum class EPCGRotatePointsMode : uint8
{
	TiltDirection                            = 0,
	EPCGRotatePointsMode_MAX                 = 1,
};
...
// ScriptStruct PCG.PCGAttributeFromPieces_AssetPath
// 0x0028 (0x0028 - 0x0000)
struct FPCGAttributeFromPieces_AssetPath final
{
public:
	...
	struct FSoftObjectPath                        SoftPath;                                          // 0x0008(0x0020)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPCGAttributeFromPieces_AssetPath) == 0x000008, "Wrong alignment on FPCGAttributeFromPieces_AssetPath");
static_assert(sizeof(FPCGAttributeFromPieces_AssetPath) == 0x000028, "Wrong size on FPCGAttributeFromPieces_AssetPath");
static_assert(offsetof(FPCGAttributeFromPieces_AssetPath, Weight) == 0x000000, "Member 'FPCGAttributeFromPieces_AssetPath::Weight' has a wrong offset!");
static_assert(offsetof(FPCGAttributeFromPieces_AssetPath, SoftPath) == 0x000008, "Member 'FPCGAttributeFromPieces_AssetPath::SoftPath' has a wrong offset!");

// ScriptStruct PCG.PCGAttributeFromPiecesEx_Piece
// 0x0018 (0x0018 - 0x0000)
struct FPCGAttributeFromPiecesEx_Piece final
{
public:
	int32                                         Weight;                                            // 0x0000(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FPCGMetadataTypesConstantStruct> Attributes;                                        // 0x0008(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPCGAttributeFromPiecesEx_Piece) == 0x000008, "Wrong alignment on FPCGAttributeFromPiecesEx_Piece");
static_assert(sizeof(FPCGAttributeFromPiecesEx_Piece) == 0x000018, "Wrong size on FPCGAttributeFromPiecesEx_Piece");
static_assert(offsetof(FPCGAttributeFromPiecesEx_Piece, Weight) == 0x000000, "Member 'FPCGAttributeFromPiecesEx_Piece::Weight' has a wrong offset!");
static_assert(offsetof(FPCGAttributeFromPiecesEx_Piece, Attributes) == 0x000008, "Member 'FPCGAttributeFromPiecesEx_Piece::Attributes' has a wrong offset!");
...
{
public:
	struct FSoftISMComponentDescriptor            Descriptor;                                        // 0x0000(0x0280)(Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FTransform>                     Instances;                                         // 0x0280(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<int64>                                 InstancesMetadataEntry;                            // 0x0290(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FPCGMeshInstanceList) == 0x0002A8, "Wrong size on FPCGMeshInstanceList");
...
static_assert(offsetof(FPCGMeshInstanceList, Instances) == 0x000280, "Member 'FPCGMeshInstanceList::Instances' has a wrong offset!");
static_assert(offsetof(FPCGMeshInstanceList, InstancesMetadataEntry) == 0x000290, "Member 'FPCGMeshInstanceList::InstancesMetadataEntry' has a wrong offset!");
...
public:
	struct FSoftISMComponentDescriptor            Descriptor;                                        // 0x0000(0x0280)(Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Weight;                                            // 0x0280(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FPCGMeshSelectorWeightedEntry) == 0x000288, "Wrong size on FPCGMeshSelectorWeightedEntry");
...
static_assert(offsetof(FPCGMeshSelectorWeightedEntry, Weight) == 0x000280, "Member 'FPCGMeshSelectorWeightedEntry::Weight' has a wrong offset!");
