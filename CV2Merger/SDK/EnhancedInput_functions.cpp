...
void IEnhancedInputSubsystemInterface::AddMappingContext(const class UInputMappingContext* MappingContext, int32 Priority, const struct FModifyContextOptions& Options, class UObject* Caller)
{
	static class UFunction* Func = nullptr;
...
void IEnhancedInputSubsystemInterface::RemoveMappingContext(const class UInputMappingContext* MappingContext, const struct FModifyContextOptions& Options, class UObject* Caller)
{
	static class UFunction* Func = nullptr;
