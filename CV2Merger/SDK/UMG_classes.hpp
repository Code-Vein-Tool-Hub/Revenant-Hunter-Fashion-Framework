...
public:
	...
	bool                                          bMouseDownDecide;                                  // 0x01B9(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UListViewBase) == 0x0002B0, "Wrong size on UListViewBase");
...
static_assert(offsetof(UListViewBase, bMouseDownDecide) == 0x0001B9, "Member 'UListViewBase::bMouseDownDecide' has a wrong offset!");
...
{
public:
	uint8                                         Pad_2B0[0x130];                                    // 0x02B0(0x0130)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          bReturnFocusToSelection;                           // 0x0C35(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_C36[0x2];                                      // 0x0C36(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UObject*>                        ListItems;                                         // 0x0C38(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_C48[0x10];                                     // 0x0C48(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         HorizontalEntrySpacing;                            // 0x0C58(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         VerticalEntrySpacing;                              // 0x0C5C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             BP_OnEntryInitialized;                             // 0x0C60(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             BP_OnItemClicked;                                  // 0x0C70(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             BP_OnItemDoubleClicked;                            // 0x0C80(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             BP_OnItemIsHoveredChanged;                         // 0x0C90(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             BP_OnItemSelectionChanged;                         // 0x0CA0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             BP_OnItemScrolledIntoView;                         // 0x0CB0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             BP_OnListViewScrolled;                             // 0x0CC0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UListView) == 0x000CD0, "Wrong size on UListView");
static_assert(offsetof(UListView, WidgetStyle) == 0x0003E0, "Member 'UListView::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UListView, ScrollBarStyle) == 0x0004C0, "Member 'UListView::ScrollBarStyle' has a wrong offset!");
static_assert(offsetof(UListView, Orientation) == 0x000C30, "Member 'UListView::Orientation' has a wrong offset!");
static_assert(offsetof(UListView, SelectionMode) == 0x000C31, "Member 'UListView::SelectionMode' has a wrong offset!");
static_assert(offsetof(UListView, ConsumeMouseWheel) == 0x000C32, "Member 'UListView::ConsumeMouseWheel' has a wrong offset!");
static_assert(offsetof(UListView, bClearSelectionOnClick) == 0x000C33, "Member 'UListView::bClearSelectionOnClick' has a wrong offset!");
static_assert(offsetof(UListView, bIsFocusable) == 0x000C34, "Member 'UListView::bIsFocusable' has a wrong offset!");
static_assert(offsetof(UListView, bReturnFocusToSelection) == 0x000C35, "Member 'UListView::bReturnFocusToSelection' has a wrong offset!");
static_assert(offsetof(UListView, ListItems) == 0x000C38, "Member 'UListView::ListItems' has a wrong offset!");
static_assert(offsetof(UListView, HorizontalEntrySpacing) == 0x000C58, "Member 'UListView::HorizontalEntrySpacing' has a wrong offset!");
static_assert(offsetof(UListView, VerticalEntrySpacing) == 0x000C5C, "Member 'UListView::VerticalEntrySpacing' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnEntryInitialized) == 0x000C60, "Member 'UListView::BP_OnEntryInitialized' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemClicked) == 0x000C70, "Member 'UListView::BP_OnItemClicked' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemDoubleClicked) == 0x000C80, "Member 'UListView::BP_OnItemDoubleClicked' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemIsHoveredChanged) == 0x000C90, "Member 'UListView::BP_OnItemIsHoveredChanged' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemSelectionChanged) == 0x000CA0, "Member 'UListView::BP_OnItemSelectionChanged' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemScrolledIntoView) == 0x000CB0, "Member 'UListView::BP_OnItemScrolledIntoView' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnListViewScrolled) == 0x000CC0, "Member 'UListView::BP_OnListViewScrolled' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             BP_OnItemExpansionChanged;                         // 0x0CF0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UTreeView) == 0x000D30, "Wrong size on UTreeView");
static_assert(offsetof(UTreeView, BP_OnGetItemChildren) == 0x000CE0, "Member 'UTreeView::BP_OnGetItemChildren' has a wrong offset!");
static_assert(offsetof(UTreeView, BP_OnItemExpansionChanged) == 0x000CF0, "Member 'UTreeView::BP_OnItemExpansionChanged' has a wrong offset!");
...
public:
	...
	struct FMargin                                Padding;                                           // 0x0220(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	int32                                         Priority;                                          // 0x0230(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bIsFocusable : 1;                                  // 0x0234(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bStopAction : 1;                                   // 0x0234(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_235[0x3];                                      // 0x0235(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FQueuedWidgetAnimationTransition> QueuedWidgetAnimationTransitions;                  // 0x0238(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	TArray<class UUMGSequencePlayer*>             ActiveSequencePlayers;                             // 0x0248(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPublic)
	class UUMGSequenceTickManager*                AnimationTickManager;                              // 0x0258(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UUMGSequencePlayer*>             StoppedSequencePlayers;                            // 0x0260(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<struct FNamedSlotBinding>              NamedSlotBindings;                                 // 0x0270(0x0010)(ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TArray<class UUserWidgetExtension*>           Extensions;                                        // 0x0280(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	class UWidgetTree*                            WidgetTree;                                        // 0x0290(0x0008)(ZeroConstructor, Transient, DuplicateTransient, NoDestructor, TextExportTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bHasScriptImplementedTick : 1;                     // 0x0298(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bHasScriptImplementedPaint : 1;                    // 0x0298(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_299[0x17];                                     // 0x0299(0x0017)(Fixing Size After Last Property [ Dumper-7 ])
	EWidgetTickFrequency                          TickFrequency;                                     // 0x02B0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2B1[0x3];                                      // 0x02B1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FWidgetChild                           DesiredFocusWidget;                                // 0x02B4(0x0010)(Edit, DisableEditOnInstance, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2C4[0x4];                                      // 0x02C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UInputComponent*                        InputComponent;                                    // 0x02C8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, DuplicateTransient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FAnimationEventBinding>         AnimationCallbacks;                                // 0x02D0(0x0010)(ZeroConstructor, Transient, DuplicateTransient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UUserWidget) == 0x0002F8, "Wrong size on UUserWidget");
...
static_assert(offsetof(UUserWidget, Padding) == 0x000220, "Member 'UUserWidget::Padding' has a wrong offset!");
static_assert(offsetof(UUserWidget, Priority) == 0x000230, "Member 'UUserWidget::Priority' has a wrong offset!");
static_assert(offsetof(UUserWidget, QueuedWidgetAnimationTransitions) == 0x000238, "Member 'UUserWidget::QueuedWidgetAnimationTransitions' has a wrong offset!");
static_assert(offsetof(UUserWidget, ActiveSequencePlayers) == 0x000248, "Member 'UUserWidget::ActiveSequencePlayers' has a wrong offset!");
static_assert(offsetof(UUserWidget, AnimationTickManager) == 0x000258, "Member 'UUserWidget::AnimationTickManager' has a wrong offset!");
static_assert(offsetof(UUserWidget, StoppedSequencePlayers) == 0x000260, "Member 'UUserWidget::StoppedSequencePlayers' has a wrong offset!");
static_assert(offsetof(UUserWidget, NamedSlotBindings) == 0x000270, "Member 'UUserWidget::NamedSlotBindings' has a wrong offset!");
static_assert(offsetof(UUserWidget, Extensions) == 0x000280, "Member 'UUserWidget::Extensions' has a wrong offset!");
static_assert(offsetof(UUserWidget, WidgetTree) == 0x000290, "Member 'UUserWidget::WidgetTree' has a wrong offset!");
static_assert(offsetof(UUserWidget, TickFrequency) == 0x0002B0, "Member 'UUserWidget::TickFrequency' has a wrong offset!");
static_assert(offsetof(UUserWidget, DesiredFocusWidget) == 0x0002B4, "Member 'UUserWidget::DesiredFocusWidget' has a wrong offset!");
static_assert(offsetof(UUserWidget, InputComponent) == 0x0002C8, "Member 'UUserWidget::InputComponent' has a wrong offset!");
static_assert(offsetof(UUserWidget, AnimationCallbacks) == 0x0002D0, "Member 'UUserWidget::AnimationCallbacks' has a wrong offset!");
...
static_assert(sizeof(UMovieScene2DTransformSection) == 0x000920, "Wrong size on UMovieScene2DTransformSection");
...
static_assert(offsetof(UMovieScene2DTransformSection, Rotation) == 0x000358, "Member 'UMovieScene2DTransformSection::Rotation' has a wrong offset!");
static_assert(offsetof(UMovieScene2DTransformSection, Scale) == 0x000480, "Member 'UMovieScene2DTransformSection::Scale' has a wrong offset!");
static_assert(offsetof(UMovieScene2DTransformSection, Shear) == 0x0006D0, "Member 'UMovieScene2DTransformSection::Shear' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneMarginSection) == 0x0005A0, "Wrong size on UMovieSceneMarginSection");
...
static_assert(offsetof(UMovieSceneMarginSection, LeftCurve) == 0x000228, "Member 'UMovieSceneMarginSection::LeftCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneMarginSection, RightCurve) == 0x000350, "Member 'UMovieSceneMarginSection::RightCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneMarginSection, BottomCurve) == 0x000478, "Member 'UMovieSceneMarginSection::BottomCurve' has a wrong offset!");
...
static_assert(offsetof(UWidgetAnimation, bLegacyFinishOnStop) == 0x000088, "Member 'UWidgetAnimation::bLegacyFinishOnStop' has a wrong offset!");
...
static_assert(sizeof(UGameViewportSubsystem) == 0x0000C0, "Wrong size on UGameViewportSubsystem");
...
public:
	...
	struct FSlateFontInfo                         Font;                                              // 0x07B8(0x0060)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETextJustify                                  Justification;                                     // 0x0818(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_819[0x3];                                      // 0x0819(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MinDesiredWidth;                                   // 0x081C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EVirtualKeyboardType                          KeyboardType;                                      // 0x0820(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ClearKeyboardFocusOnCommit;                        // 0x0821(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          SelectAllTextOnCommit;                             // 0x0822(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_823[0x1];                                      // 0x0823(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSlateColor                            ForegroundColor;                                   // 0x0824(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnValueChanged;                                    // 0x0838(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnValueCommitted;                                  // 0x0848(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnBeginSliderMovement;                             // 0x0858(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnEndSliderMovement;                               // 0x0868(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         bOverride_MinValue : 1;                            // 0x0878(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bOverride_MaxValue : 1;                            // 0x0878(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bOverride_MinSliderValue : 1;                      // 0x0878(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bOverride_MaxSliderValue : 1;                      // 0x0878(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_879[0x3];                                      // 0x0879(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MinValue;                                          // 0x087C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         MaxValue;                                          // 0x0880(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         MinSliderValue;                                    // 0x0884(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         MaxSliderValue;                                    // 0x0888(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(USpinBox, Justification) == 0x000818, "Member 'USpinBox::Justification' has a wrong offset!");
static_assert(offsetof(USpinBox, MinDesiredWidth) == 0x00081C, "Member 'USpinBox::MinDesiredWidth' has a wrong offset!");
static_assert(offsetof(USpinBox, KeyboardType) == 0x000820, "Member 'USpinBox::KeyboardType' has a wrong offset!");
static_assert(offsetof(USpinBox, ClearKeyboardFocusOnCommit) == 0x000821, "Member 'USpinBox::ClearKeyboardFocusOnCommit' has a wrong offset!");
static_assert(offsetof(USpinBox, SelectAllTextOnCommit) == 0x000822, "Member 'USpinBox::SelectAllTextOnCommit' has a wrong offset!");
static_assert(offsetof(USpinBox, ForegroundColor) == 0x000824, "Member 'USpinBox::ForegroundColor' has a wrong offset!");
static_assert(offsetof(USpinBox, OnValueChanged) == 0x000838, "Member 'USpinBox::OnValueChanged' has a wrong offset!");
static_assert(offsetof(USpinBox, OnValueCommitted) == 0x000848, "Member 'USpinBox::OnValueCommitted' has a wrong offset!");
static_assert(offsetof(USpinBox, OnBeginSliderMovement) == 0x000858, "Member 'USpinBox::OnBeginSliderMovement' has a wrong offset!");
static_assert(offsetof(USpinBox, OnEndSliderMovement) == 0x000868, "Member 'USpinBox::OnEndSliderMovement' has a wrong offset!");
static_assert(offsetof(USpinBox, MinValue) == 0x00087C, "Member 'USpinBox::MinValue' has a wrong offset!");
static_assert(offsetof(USpinBox, MaxValue) == 0x000880, "Member 'USpinBox::MaxValue' has a wrong offset!");
static_assert(offsetof(USpinBox, MinSliderValue) == 0x000884, "Member 'USpinBox::MinSliderValue' has a wrong offset!");
static_assert(offsetof(USpinBox, MaxSliderValue) == 0x000888, "Member 'USpinBox::MaxSliderValue' has a wrong offset!");
...
// 0x0380 (0x0500 - 0x0180)
class UEditableText final : public UWidget
{
public:
	class FText                                   Text;                                              // 0x0180(0x0010)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TDelegate<void()>                             TextDelegate;                                      // 0x0190(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   HintText;                                          // 0x01A0(0x0010)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TDelegate<void()>                             HintTextDelegate;                                  // 0x01B0(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UEditableText, TextDelegate) == 0x000190, "Member 'UEditableText::TextDelegate' has a wrong offset!");
static_assert(offsetof(UEditableText, HintText) == 0x0001A0, "Member 'UEditableText::HintText' has a wrong offset!");
static_assert(offsetof(UEditableText, HintTextDelegate) == 0x0001B0, "Member 'UEditableText::HintTextDelegate' has a wrong offset!");
...
static_assert(offsetof(UEditableTextBox, TextDelegate) == 0x000190, "Member 'UEditableTextBox::TextDelegate' has a wrong offset!");
...
{
public:
	struct FShapedTextOptions                     ShapedTextOptions;                                 // 0x0180(0x0003)(Edit, BlueprintVisible, NoDestructor, AdvancedDisplay, Protected, NativeAccessSpecifierProtected)
	...
	ETextWrappingPolicy                           WrappingPolicy;                                    // 0x0184(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         AutoWrapText : 1;                                  // 0x0185(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_186[0x2];                                      // 0x0186(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         WrapTextAt;                                        // 0x0188(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FMargin                                Margin;                                            // 0x018C(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, NativeAccessSpecifierProtected)
	float                                         LineHeightPercentage;                              // 0x019C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          ApplyLineHeightToBottomLine;                       // 0x01A0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UTextLayoutWidget) == 0x0001A8, "Wrong size on UTextLayoutWidget");
...
static_assert(offsetof(UTextLayoutWidget, ApplyLineHeightToBottomLine) == 0x0001A0, "Member 'UTextLayoutWidget::ApplyLineHeightToBottomLine' has a wrong offset!");

// Class UMG.MultiLineEditableText
// 0x03B8 (0x0560 - 0x01A8)
class UMultiLineEditableText final : public UTextLayoutWidget
{
public:
	class FText                                   Text;                                              // 0x01A8(0x0010)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class FText                                   HintText;                                          // 0x01B8(0x0010)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TDelegate<void()>                             HintTextDelegate;                                  // 0x01C8(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMultiLineEditableText, Text) == 0x0001A8, "Member 'UMultiLineEditableText::Text' has a wrong offset!");
...
static_assert(offsetof(UMultiLineEditableText, HintTextDelegate) == 0x0001C8, "Member 'UMultiLineEditableText::HintTextDelegate' has a wrong offset!");
...
static_assert(offsetof(UMultiLineEditableTextBox, Text) == 0x0001A8, "Member 'UMultiLineEditableTextBox::Text' has a wrong offset!");
...
static_assert(offsetof(UMultiLineEditableTextBox, HintTextDelegate) == 0x0001C8, "Member 'UMultiLineEditableTextBox::HintTextDelegate' has a wrong offset!");
...
{
public:
	bool                                          bPerformDefaultPostBufferUpdate;                   // 0x0180(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_181[0x7];                                      // 0x0181(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<ESlatePostRT>                          BuffersToUpdate;                                   // 0x0188(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_198[0x10];                                     // 0x0198(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPostBufferUpdate) == 0x0001A8, "Wrong size on UPostBufferUpdate");
static_assert(offsetof(UPostBufferUpdate, bPerformDefaultPostBufferUpdate) == 0x000180, "Member 'UPostBufferUpdate::bPerformDefaultPostBufferUpdate' has a wrong offset!");
static_assert(offsetof(UPostBufferUpdate, BuffersToUpdate) == 0x000188, "Member 'UPostBufferUpdate::BuffersToUpdate' has a wrong offset!");
...
// 0x06F8 (0x08A0 - 0x01A8)
class URichTextBlock : public UTextLayoutWidget
{
public:
	class FText                                   Text;                                              // 0x01A8(0x0010)(Edit, BlueprintVisible, Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(URichTextBlock, Text) == 0x0001A8, "Member 'URichTextBlock::Text' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnScrollBarVisibilityChanged;                      // 0x0CD0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_CE0[0x18];                                     // 0x0CE0(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UScrollBox) == 0x000D00, "Wrong size on UScrollBox");
...
static_assert(offsetof(UScrollBox, OnScrollBarVisibilityChanged) == 0x000CD0, "Member 'UScrollBox::OnScrollBarVisibilityChanged' has a wrong offset!");
...
public:
	...
	struct FSlateFontInfo                         Font;                                              // 0x01F0(0x0060)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UTextBlock, Text) == 0x0001A8, "Member 'UTextBlock::Text' has a wrong offset!");
...
public:
	...
	ESlateVisibility                              ScrollbarDisabledVisibility;                       // 0x0CDA(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_CDB[0x15];                                     // 0x0CDB(0x0015)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bEntrySizeIncludesEntrySpacing;                    // 0x0CF0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_CF1[0x7];                                      // 0x0CF1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UTileView) == 0x000D00, "Wrong size on UTileView");
static_assert(offsetof(UTileView, EntryHeight) == 0x000CD0, "Member 'UTileView::EntryHeight' has a wrong offset!");
static_assert(offsetof(UTileView, EntryWidth) == 0x000CD4, "Member 'UTileView::EntryWidth' has a wrong offset!");
static_assert(offsetof(UTileView, TileAlignment) == 0x000CD8, "Member 'UTileView::TileAlignment' has a wrong offset!");
static_assert(offsetof(UTileView, bWrapHorizontalNavigation) == 0x000CD9, "Member 'UTileView::bWrapHorizontalNavigation' has a wrong offset!");
static_assert(offsetof(UTileView, ScrollbarDisabledVisibility) == 0x000CDA, "Member 'UTileView::ScrollbarDisabledVisibility' has a wrong offset!");
static_assert(offsetof(UTileView, bEntrySizeIncludesEntrySpacing) == 0x000CF0, "Member 'UTileView::bEntrySizeIncludesEntrySpacing' has a wrong offset!");
