...
public:
	...
	uint8                                         Pad_534[0x54];                                     // 0x0534(0x0054)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UMRMeshBodyHolder*>              BodyHolders;                                       // 0x0588(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMRMeshComponent, BodyHolders) == 0x000588, "Member 'UMRMeshComponent::BodyHolders' has a wrong offset!");
