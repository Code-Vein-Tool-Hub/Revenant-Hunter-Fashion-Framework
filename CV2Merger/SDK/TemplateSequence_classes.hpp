...
public:
	...
	uint8                                         Pad_7FC[0x74];                                     // 0x07FC(0x0074)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCameraAnimationEntitySystemLinker) == 0x000780, "Wrong size on UCameraAnimationEntitySystemLinker");
...
static_assert(sizeof(UTemplateSequenceSection) == 0x000150, "Wrong size on UTemplateSequenceSection");
static_assert(offsetof(UTemplateSequenceSection, PropertyScales) == 0x000140, "Member 'UTemplateSequenceSection::PropertyScales' has a wrong offset!");
