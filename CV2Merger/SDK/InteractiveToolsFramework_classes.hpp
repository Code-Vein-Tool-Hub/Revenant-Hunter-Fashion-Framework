...
public:
	...
	TArray<class UPrimitiveComponent*>            ActiveComponents;                                  // 0x01D0(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class UInteractiveGizmo*>              ActiveGizmos;                                      // 0x01E0(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_1F0[0x50];                                     // 0x01F0(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	class UGizmoConstantFrameAxisSource*          CameraAxisSource;                                  // 0x0240(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoComponentAxisSource*              AxisXSource;                                       // 0x0248(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoComponentAxisSource*              AxisYSource;                                       // 0x0250(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoComponentAxisSource*              AxisZSource;                                       // 0x0258(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoComponentAxisSource*              UnitAxisXSource;                                   // 0x0260(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoComponentAxisSource*              UnitAxisYSource;                                   // 0x0268(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoComponentAxisSource*              UnitAxisZSource;                                   // 0x0270(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UGizmoTransformChangeStateTarget*       StateTarget;                                       // 0x0278(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCombinedTransformGizmo) == 0x0003C0, "Wrong size on UCombinedTransformGizmo");
...
static_assert(offsetof(UCombinedTransformGizmo, ActiveComponents) == 0x0001D0, "Member 'UCombinedTransformGizmo::ActiveComponents' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, ActiveGizmos) == 0x0001E0, "Member 'UCombinedTransformGizmo::ActiveGizmos' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, CameraAxisSource) == 0x000240, "Member 'UCombinedTransformGizmo::CameraAxisSource' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, AxisXSource) == 0x000248, "Member 'UCombinedTransformGizmo::AxisXSource' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, AxisYSource) == 0x000250, "Member 'UCombinedTransformGizmo::AxisYSource' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, AxisZSource) == 0x000258, "Member 'UCombinedTransformGizmo::AxisZSource' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, UnitAxisXSource) == 0x000260, "Member 'UCombinedTransformGizmo::UnitAxisXSource' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, UnitAxisYSource) == 0x000268, "Member 'UCombinedTransformGizmo::UnitAxisYSource' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, UnitAxisZSource) == 0x000270, "Member 'UCombinedTransformGizmo::UnitAxisZSource' has a wrong offset!");
static_assert(offsetof(UCombinedTransformGizmo, StateTarget) == 0x000278, "Member 'UCombinedTransformGizmo::StateTarget' has a wrong offset!");
...
static_assert(sizeof(UIntervalGizmo) == 0x000210, "Wrong size on UIntervalGizmo");
static_assert(offsetof(UIntervalGizmo, StateTarget) == 0x000038, "Member 'UIntervalGizmo::StateTarget' has a wrong offset!");
static_assert(offsetof(UIntervalGizmo, TransformProxy) == 0x0000B0, "Member 'UIntervalGizmo::TransformProxy' has a wrong offset!");
static_assert(offsetof(UIntervalGizmo, ActiveComponents) == 0x0000B8, "Member 'UIntervalGizmo::ActiveComponents' has a wrong offset!");
static_assert(offsetof(UIntervalGizmo, ActiveGizmos) == 0x0000C8, "Member 'UIntervalGizmo::ActiveGizmos' has a wrong offset!");
static_assert(offsetof(UIntervalGizmo, AxisYSource) == 0x0000F0, "Member 'UIntervalGizmo::AxisYSource' has a wrong offset!");
static_assert(offsetof(UIntervalGizmo, AxisZSource) == 0x0000F8, "Member 'UIntervalGizmo::AxisZSource' has a wrong offset!");
...
public:
	...
	class UGizmoTransformChangeStateTarget*       RepositionStateTarget;                             // 0x0450(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(URepositionableTransformGizmo) == 0x000460, "Wrong size on URepositionableTransformGizmo");
static_assert(offsetof(URepositionableTransformGizmo, RepositionStateTarget) == 0x000450, "Member 'URepositionableTransformGizmo::RepositionStateTarget' has a wrong offset!");
...
static_assert(sizeof(UTransformProxy) == 0x0001E0, "Wrong size on UTransformProxy");
static_assert(offsetof(UTransformProxy, bRotatePerObject) == 0x000108, "Member 'UTransformProxy::bRotatePerObject' has a wrong offset!");
static_assert(offsetof(UTransformProxy, bSetPivotMode) == 0x000109, "Member 'UTransformProxy::bSetPivotMode' has a wrong offset!");
static_assert(offsetof(UTransformProxy, SharedTransform) == 0x000120, "Member 'UTransformProxy::SharedTransform' has a wrong offset!");
static_assert(offsetof(UTransformProxy, InitialSharedTransform) == 0x000180, "Member 'UTransformProxy::InitialSharedTransform' has a wrong offset!");
...
static_assert(sizeof(UGizmoTransformProxyTransformSource) == 0x000080, "Wrong size on UGizmoTransformProxyTransformSource");
...
static_assert(offsetof(UInteractiveTool, InputBehaviors) == 0x000070, "Member 'UInteractiveTool::InputBehaviors' has a wrong offset!");
static_assert(offsetof(UInteractiveTool, ToolPropertyObjects) == 0x000078, "Member 'UInteractiveTool::ToolPropertyObjects' has a wrong offset!");
...
public:
	...
	class UBrushStampIndicator*                   BrushStampIndicator;                               // 0x0290(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBaseBrushTool) == 0x0002A8, "Wrong size on UBaseBrushTool");
...
static_assert(offsetof(UBaseBrushTool, PropertyClass) == 0x000268, "Member 'UBaseBrushTool::PropertyClass' has a wrong offset!");
static_assert(offsetof(UBaseBrushTool, BrushStampIndicator) == 0x000290, "Member 'UBaseBrushTool::BrushStampIndicator' has a wrong offset!");
...
public:
	...
	TMap<class FString, class UInteractiveToolBuilder*> ToolBuilders;                                      // 0x0130(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UInteractiveToolManager) == 0x0001E0, "Wrong size on UInteractiveToolManager");
...
static_assert(offsetof(UInteractiveToolManager, ToolBuilders) == 0x000130, "Member 'UInteractiveToolManager::ToolBuilders' has a wrong offset!");
...
static_assert(offsetof(UInteractiveToolsContext, InputRouter) == 0x000068, "Member 'UInteractiveToolsContext::InputRouter' has a wrong offset!");
static_assert(offsetof(UInteractiveToolsContext, TargetManager) == 0x000070, "Member 'UInteractiveToolsContext::TargetManager' has a wrong offset!");
static_assert(offsetof(UInteractiveToolsContext, ToolManager) == 0x000078, "Member 'UInteractiveToolsContext::ToolManager' has a wrong offset!");
static_assert(offsetof(UInteractiveToolsContext, GizmoManager) == 0x000080, "Member 'UInteractiveToolsContext::GizmoManager' has a wrong offset!");
static_assert(offsetof(UInteractiveToolsContext, ContextObjectStore) == 0x000088, "Member 'UInteractiveToolsContext::ContextObjectStore' has a wrong offset!");
