...
static_assert(sizeof(UEnhancedInputActionDelegateBinding) == 0x000048, "Wrong size on UEnhancedInputActionDelegateBinding");
...
{
public:
	void AddMappingContext(const class UInputMappingContext* MappingContext, int32 Priority, const struct FModifyContextOptions& Options, class UObject* Caller);
	...
	void RemoveMappingContext(const class UInputMappingContext* MappingContext, const struct FModifyContextOptions& Options, class UObject* Caller);
...
public:
	...
	TMap<class UInputMappingContext*, int32>      MappingContextMap;                                 // 0x01E8(0x0050)(Transient, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UEnhancedInputLocalPlayerSubsystem) == 0x000238, "Wrong size on UEnhancedInputLocalPlayerSubsystem");
...
static_assert(offsetof(UEnhancedInputLocalPlayerSubsystem, MappingContextMap) == 0x0001E8, "Member 'UEnhancedInputLocalPlayerSubsystem::MappingContextMap' has a wrong offset!");
