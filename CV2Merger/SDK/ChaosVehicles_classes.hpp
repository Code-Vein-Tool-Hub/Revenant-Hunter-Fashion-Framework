...
{
public:
	uint8                                         Pad_368[0x868];                                    // 0x0368(0x0868)(Fixing Size After Last Property [ Dumper-7 ])
	class UChaosWheeledVehicleMovementComponent*  WheeledVehicleComponent;                           // 0x0BD0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UVehicleAnimationInstance) == 0x000BE0, "Wrong size on UVehicleAnimationInstance");
static_assert(offsetof(UVehicleAnimationInstance, WheeledVehicleComponent) == 0x000BD0, "Member 'UVehicleAnimationInstance::WheeledVehicleComponent' has a wrong offset!");
