...
public:
	...
	uint8                                         bIsDisabled : 1;                                   // 0x0088(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_89[0x3];                                       // 0x0089(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGuid                                  Guid;                                              // 0x008C(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieGraphNode) == 0x0000A0, "Wrong size on UMovieGraphNode");
...
static_assert(offsetof(UMovieGraphNode, Guid) == 0x00008C, "Member 'UMovieGraphNode::Guid' has a wrong offset!");
...
static_assert(sizeof(UMovieGraphSettingNode) == 0x0000A0, "Wrong size on UMovieGraphSettingNode");
...
static_assert(sizeof(UMovieGraphRenderPassNode) == 0x0000A0, "Wrong size on UMovieGraphRenderPassNode");
...
static_assert(sizeof(UMovieGraphApplyCVarPresetNode) == 0x0000B8, "Wrong size on UMovieGraphApplyCVarPresetNode");
static_assert(offsetof(UMovieGraphApplyCVarPresetNode, ConsoleVariablePreset) == 0x0000A8, "Member 'UMovieGraphApplyCVarPresetNode::ConsoleVariablePreset' has a wrong offset!");
...
static_assert(sizeof(UMovieGraphBranchNode) == 0x0000A0, "Wrong size on UMovieGraphBranchNode");
...
static_assert(sizeof(UMovieGraphFileOutputNode) == 0x0000B8, "Wrong size on UMovieGraphFileOutputNode");
static_assert(offsetof(UMovieGraphFileOutputNode, FileNameFormat) == 0x0000A8, "Member 'UMovieGraphFileOutputNode::FileNameFormat' has a wrong offset!");
...
static_assert(sizeof(UMovieGraphAudioOutputNode) == 0x0000C8, "Wrong size on UMovieGraphAudioOutputNode");
...
{
public:
	uint8                                         bOverride_bCompositeOntoFinalImage : 1;            // 0x00A0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	bool                                          bCompositeOntoFinalImage;                          // 0x00A1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A2[0x76];                                      // 0x00A2(0x0076)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieGraphWidgetRendererBaseNode) == 0x000118, "Wrong size on UMovieGraphWidgetRendererBaseNode");
static_assert(offsetof(UMovieGraphWidgetRendererBaseNode, bCompositeOntoFinalImage) == 0x0000A1, "Member 'UMovieGraphWidgetRendererBaseNode::bCompositeOntoFinalImage' has a wrong offset!");
...
{
public:
	uint8                                         bOverride_BurnInClass : 1;                         // 0x0118(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_119[0x7];                                      // 0x0119(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSoftClassPath                         BurnInClass;                                       // 0x0120(0x0020)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class UClass*, class UMovieGraphBurnInWidget*> BurnInWidgetInstances;                             // 0x0140(0x0050)(ExportObject, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieGraphBurnInNode, BurnInClass) == 0x000120, "Member 'UMovieGraphBurnInNode::BurnInClass' has a wrong offset!");
static_assert(offsetof(UMovieGraphBurnInNode, BurnInWidgetInstances) == 0x000140, "Member 'UMovieGraphBurnInNode::BurnInWidgetInstances' has a wrong offset!");
...
static_assert(sizeof(UMovieGraphBurnInWidget) == 0x0002F8, "Wrong size on UMovieGraphBurnInWidget");
...
{
public:
	uint8                                         bOverride_ShutterTiming : 1;                       // 0x00A0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_OverscanPercentage : 1;                  // 0x00A0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	EMoviePipelineShutterTiming                   ShutterTiming;                                     // 0x00A1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A2[0x2];                                       // 0x00A2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         OverscanPercentage;                                // 0x00A4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieGraphCameraSettingNode) == 0x0000A8, "Wrong size on UMovieGraphCameraSettingNode");
static_assert(offsetof(UMovieGraphCameraSettingNode, ShutterTiming) == 0x0000A1, "Member 'UMovieGraphCameraSettingNode::ShutterTiming' has a wrong offset!");
static_assert(offsetof(UMovieGraphCameraSettingNode, OverscanPercentage) == 0x0000A4, "Member 'UMovieGraphCameraSettingNode::OverscanPercentage' has a wrong offset!");
...
{
public:
	uint8                                         bOverride_Collection : 1;                          // 0x00A0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_A1[0x7];                                       // 0x00A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UMovieGraphCollection*                  Collection;                                        // 0x00A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, EditConst, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMovieGraphCollectionNode, Collection) == 0x0000A8, "Member 'UMovieGraphCollectionNode::Collection' has a wrong offset!");
...
public:
	...
	uint8                                         bOverride_bDeleteSourceFiles : 1;                  // 0x00A8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bSkipEncodeOnRenderCanceled : 1;         // 0x00A8(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_VideoCodec : 1;                          // 0x00A8(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_AudioCodec : 1;                          // 0x00A8(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_OutputFileExtension : 1;                 // 0x00A8(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_CommandLineFormat : 1;                   // 0x00A8(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_VideoInputStringFormat : 1;              // 0x00A8(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_AudioInputStringFormat : 1;              // 0x00A9(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_EncodeSettings : 1;                      // 0x00A9(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bRetainInputTextFiles : 1;               // 0x00A9(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	bool                                          bDeleteSourceFiles;                                // 0x00C0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSkipEncodeOnRenderCanceled;                       // 0x00C1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C2[0x6];                                       // 0x00C2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 VideoCodec;                                        // 0x00C8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AudioCodec;                                        // 0x00D8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 OutputFileExtension;                               // 0x00E8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 CommandLineFormat;                                 // 0x00F8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 VideoInputStringFormat;                            // 0x0108(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AudioInputStringFormat;                            // 0x0118(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 EncodeSettings;                                    // 0x0128(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRetainInputTextFiles;                             // 0x0138(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieGraphCommandLineEncoderNode) == 0x000140, "Wrong size on UMovieGraphCommandLineEncoderNode");
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, FileNameFormat) == 0x0000B0, "Member 'UMovieGraphCommandLineEncoderNode::FileNameFormat' has a wrong offset!");
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, bDeleteSourceFiles) == 0x0000C0, "Member 'UMovieGraphCommandLineEncoderNode::bDeleteSourceFiles' has a wrong offset!");
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, bSkipEncodeOnRenderCanceled) == 0x0000C1, "Member 'UMovieGraphCommandLineEncoderNode::bSkipEncodeOnRenderCanceled' has a wrong offset!");
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, VideoCodec) == 0x0000C8, "Member 'UMovieGraphCommandLineEncoderNode::VideoCodec' has a wrong offset!");
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, AudioCodec) == 0x0000D8, "Member 'UMovieGraphCommandLineEncoderNode::AudioCodec' has a wrong offset!");
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, OutputFileExtension) == 0x0000E8, "Member 'UMovieGraphCommandLineEncoderNode::OutputFileExtension' has a wrong offset!");
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, CommandLineFormat) == 0x0000F8, "Member 'UMovieGraphCommandLineEncoderNode::CommandLineFormat' has a wrong offset!");
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, VideoInputStringFormat) == 0x000108, "Member 'UMovieGraphCommandLineEncoderNode::VideoInputStringFormat' has a wrong offset!");
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, AudioInputStringFormat) == 0x000118, "Member 'UMovieGraphCommandLineEncoderNode::AudioInputStringFormat' has a wrong offset!");
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, EncodeSettings) == 0x000128, "Member 'UMovieGraphCommandLineEncoderNode::EncodeSettings' has a wrong offset!");
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, bRetainInputTextFiles) == 0x000138, "Member 'UMovieGraphCommandLineEncoderNode::bRetainInputTextFiles' has a wrong offset!");
...
{
public:
	uint8                                         bOverride_bCaptureFramesWithRenderDoc : 1;         // 0x00A0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bCaptureUnrealInsightsTrace : 1;         // 0x00A0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_UnrealInsightsTraceFileNameFormat : 1;   // 0x00A0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	bool                                          bCaptureFramesWithRenderDoc;                       // 0x00A1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCaptureUnrealInsightsTrace;                       // 0x00A2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A3[0x5];                                       // 0x00A3(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 UnrealInsightsTraceFileNameFormat;                 // 0x00A8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieGraphDebugSettingNode) == 0x0000B8, "Wrong size on UMovieGraphDebugSettingNode");
static_assert(offsetof(UMovieGraphDebugSettingNode, bCaptureFramesWithRenderDoc) == 0x0000A1, "Member 'UMovieGraphDebugSettingNode::bCaptureFramesWithRenderDoc' has a wrong offset!");
static_assert(offsetof(UMovieGraphDebugSettingNode, bCaptureUnrealInsightsTrace) == 0x0000A2, "Member 'UMovieGraphDebugSettingNode::bCaptureUnrealInsightsTrace' has a wrong offset!");
static_assert(offsetof(UMovieGraphDebugSettingNode, UnrealInsightsTraceFileNameFormat) == 0x0000A8, "Member 'UMovieGraphDebugSettingNode::UnrealInsightsTraceFileNameFormat' has a wrong offset!");
...
{
public:
	uint8                                         bOverride_Script : 1;                              // 0x00A0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_A1[0x7];                                       // 0x00A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSoftClassPath                         Script;                                            // 0x00A8(0x0020)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieGraphExecuteScriptNode) == 0x0000C8, "Wrong size on UMovieGraphExecuteScriptNode");
static_assert(offsetof(UMovieGraphExecuteScriptNode, Script) == 0x0000A8, "Member 'UMovieGraphExecuteScriptNode::Script' has a wrong offset!");
...
{
public:
	uint8                                         bOverride_GameModeOverride : 1;                    // 0x00A0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_ScalabilityQualityLevel : 1;             // 0x00A0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bDisableTextureStreaming : 1;            // 0x00A0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bDisableLODs : 1;                        // 0x00A0(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bDisableHLODs : 1;                       // 0x00A0(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bFlushLevelStreaming : 1;                // 0x00A0(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bFlushAssetCompiler : 1;                 // 0x00A0(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bFlushShaderCompiler : 1;                // 0x00A0(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bFlushGrassStreaming : 1;                // 0x00A1(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bFlushStreamingManagers : 1;             // 0x00A1(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_VirtualTextureFeedbackFactor : 1;        // 0x00A1(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_A2[0x6];                                       // 0x00A2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class AGameModeBase>              GameModeOverride;                                  // 0x00A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EMovieGraphScalabilityQualityLevel            ScalabilityQualityLevel;                           // 0x00B0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDisableTextureStreaming;                          // 0x00B1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDisableLODs;                                      // 0x00B2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDisableHLODs;                                     // 0x00B3(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bFlushLevelStreaming;                              // 0x00B4(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bFlushAssetCompiler;                               // 0x00B5(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bFlushShaderCompiler;                              // 0x00B6(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bFlushGrassStreaming;                              // 0x00B7(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bFlushStreamingManagers;                           // 0x00B8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B9[0x3];                                       // 0x00B9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         VirtualTextureFeedbackFactor;                      // 0x00BC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieGraphGlobalGameOverridesNode) == 0x000160, "Wrong size on UMovieGraphGlobalGameOverridesNode");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, GameModeOverride) == 0x0000A8, "Member 'UMovieGraphGlobalGameOverridesNode::GameModeOverride' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, ScalabilityQualityLevel) == 0x0000B0, "Member 'UMovieGraphGlobalGameOverridesNode::ScalabilityQualityLevel' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, bDisableTextureStreaming) == 0x0000B1, "Member 'UMovieGraphGlobalGameOverridesNode::bDisableTextureStreaming' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, bDisableLODs) == 0x0000B2, "Member 'UMovieGraphGlobalGameOverridesNode::bDisableLODs' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, bDisableHLODs) == 0x0000B3, "Member 'UMovieGraphGlobalGameOverridesNode::bDisableHLODs' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, bFlushLevelStreaming) == 0x0000B4, "Member 'UMovieGraphGlobalGameOverridesNode::bFlushLevelStreaming' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, bFlushAssetCompiler) == 0x0000B5, "Member 'UMovieGraphGlobalGameOverridesNode::bFlushAssetCompiler' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, bFlushShaderCompiler) == 0x0000B6, "Member 'UMovieGraphGlobalGameOverridesNode::bFlushShaderCompiler' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, bFlushGrassStreaming) == 0x0000B7, "Member 'UMovieGraphGlobalGameOverridesNode::bFlushGrassStreaming' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, bFlushStreamingManagers) == 0x0000B8, "Member 'UMovieGraphGlobalGameOverridesNode::bFlushStreamingManagers' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, VirtualTextureFeedbackFactor) == 0x0000BC, "Member 'UMovieGraphGlobalGameOverridesNode::VirtualTextureFeedbackFactor' has a wrong offset!");
...
{
public:
	uint8                                         bOverride_OutputDirectory : 1;                     // 0x00A0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_OutputResolution : 1;                    // 0x00A0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_OutputFrameRate : 1;                     // 0x00A0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bOverwriteExistingOutput : 1;            // 0x00A0(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_ZeroPadFrameNumbers : 1;                 // 0x00A0(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_FrameNumberOffset : 1;                   // 0x00A0(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_HandleFrameCount : 1;                    // 0x00A0(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_CustomPlaybackRangeStartFrame : 1;       // 0x00A0(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_CustomPlaybackRangeEndFrame : 1;         // 0x00A1(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_VersioningSettings : 1;                  // 0x00A1(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bFlushDiskWritesPerShot : 1;             // 0x00A1(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_A2[0x6];                                       // 0x00A2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDirectoryPath                         OutputDirectory;                                   // 0x00A8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMovieGraphNamedResolution             OutputResolution;                                  // 0x00B8(0x0020)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FFrameRate                             OutputFrameRate;                                   // 0x00D8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOverwriteExistingOutput;                          // 0x00E0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_E1[0x3];                                       // 0x00E1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         ZeroPadFrameNumbers;                               // 0x00E4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         FrameNumberOffset;                                 // 0x00E8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         HandleFrameCount;                                  // 0x00EC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         CustomPlaybackRangeStartFrame;                     // 0x00F0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         CustomPlaybackRangeEndFrame;                       // 0x00F4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMovieGraphVersioningSettings          VersioningSettings;                                // 0x00F8(0x0008)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bFlushDiskWritesPerShot;                           // 0x0100(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieGraphGlobalOutputSettingNode) == 0x000108, "Wrong size on UMovieGraphGlobalOutputSettingNode");
static_assert(offsetof(UMovieGraphGlobalOutputSettingNode, OutputDirectory) == 0x0000A8, "Member 'UMovieGraphGlobalOutputSettingNode::OutputDirectory' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalOutputSettingNode, OutputResolution) == 0x0000B8, "Member 'UMovieGraphGlobalOutputSettingNode::OutputResolution' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalOutputSettingNode, OutputFrameRate) == 0x0000D8, "Member 'UMovieGraphGlobalOutputSettingNode::OutputFrameRate' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalOutputSettingNode, bOverwriteExistingOutput) == 0x0000E0, "Member 'UMovieGraphGlobalOutputSettingNode::bOverwriteExistingOutput' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalOutputSettingNode, ZeroPadFrameNumbers) == 0x0000E4, "Member 'UMovieGraphGlobalOutputSettingNode::ZeroPadFrameNumbers' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalOutputSettingNode, FrameNumberOffset) == 0x0000E8, "Member 'UMovieGraphGlobalOutputSettingNode::FrameNumberOffset' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalOutputSettingNode, HandleFrameCount) == 0x0000EC, "Member 'UMovieGraphGlobalOutputSettingNode::HandleFrameCount' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalOutputSettingNode, CustomPlaybackRangeStartFrame) == 0x0000F0, "Member 'UMovieGraphGlobalOutputSettingNode::CustomPlaybackRangeStartFrame' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalOutputSettingNode, CustomPlaybackRangeEndFrame) == 0x0000F4, "Member 'UMovieGraphGlobalOutputSettingNode::CustomPlaybackRangeEndFrame' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalOutputSettingNode, VersioningSettings) == 0x0000F8, "Member 'UMovieGraphGlobalOutputSettingNode::VersioningSettings' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalOutputSettingNode, bFlushDiskWritesPerShot) == 0x000100, "Member 'UMovieGraphGlobalOutputSettingNode::bFlushDiskWritesPerShot' has a wrong offset!");
...
static_assert(sizeof(UMovieGraphInputNode) == 0x0000A0, "Wrong size on UMovieGraphInputNode");
...
{
public:
	uint8                                         bOverride_ModifierName : 1;                        // 0x00A0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_A1[0x7];                                       // 0x00A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 ModifierName;                                      // 0x00A8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bOverride_Collections : 1;                         // 0x00B8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bOverride_ModifiersContainer : 1;                  // 0x00B8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_B9[0x7];                                       // 0x00B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           Collections;                                       // 0x00C0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	class UMovieGraphMergeableModifierContainer*  ModifiersContainer;                                // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieGraphModifierNode) == 0x0000D8, "Wrong size on UMovieGraphModifierNode");
static_assert(offsetof(UMovieGraphModifierNode, ModifierName) == 0x0000A8, "Member 'UMovieGraphModifierNode::ModifierName' has a wrong offset!");
static_assert(offsetof(UMovieGraphModifierNode, Collections) == 0x0000C0, "Member 'UMovieGraphModifierNode::Collections' has a wrong offset!");
static_assert(offsetof(UMovieGraphModifierNode, ModifiersContainer) == 0x0000D0, "Member 'UMovieGraphModifierNode::ModifiersContainer' has a wrong offset!");
...
static_assert(sizeof(UMovieGraphOutputNode) == 0x0000A0, "Wrong size on UMovieGraphOutputNode");
...
static_assert(sizeof(UMoviePipelineBase) == 0x000088, "Wrong size on UMoviePipelineBase");
...
{
public:
	TArray<class UMovieGraphTimeStepBase*>        GraphTimeStepInstances;                            // 0x0088(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class UMovieGraphTimeStepBase*                PendingTimeStepInstance;                           // 0x0098(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMovieGraphTimeStepBase*                GraphTimeStepInstance;                             // 0x00A0(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMovieGraphRendererBase*                GraphRendererInstance;                             // 0x00A8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMovieGraphDataSourceBase*              GraphDataSourceInstance;                           // 0x00B0(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMovieGraphAudioRendererBase*           GraphAudioRendererInstance;                        // 0x00B8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMovieGraphEvaluatedConfig*             PostRenderEvaluatedGraph;                          // 0x00C0(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMoviePipelineExecutorJob*              CurrentJob;                                        // 0x00C8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMoviePipelineExecutorJob*              CurrentJobDuplicate;                               // 0x00D0(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UMoviePipelineExecutorShot*>     ActiveShotList;                                    // 0x00D8(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TSubclassOf<class UMovieGraphRenderPreviewWidget> PreviewWidgetClassToUse;                           // 0x00E8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMovieGraphRenderPreviewWidget*         PreviewWidget;                                     // 0x00F0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UMovieGraphScriptBase*>          CurrentScriptInstances;                            // 0x00F8(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	TSet<class UMovieGraphFileOutputNode*>        OutputNodesDataSentTo;                             // 0x0108(0x0050)(Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_158[0x70];                                     // 0x0158(0x0070)(Fixing Size After Last Property [ Dumper-7 ])
	class UMovieGraphEngineTimeStep*              CustomEngineTimeStep;                              // 0x01C8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UEngineCustomTimeStep*                  PrevCustomEngineTimeStep;                          // 0x01D0(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieGraphPipeline) == 0x0001D8, "Wrong size on UMovieGraphPipeline");
static_assert(offsetof(UMovieGraphPipeline, GraphTimeStepInstances) == 0x000088, "Member 'UMovieGraphPipeline::GraphTimeStepInstances' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, PendingTimeStepInstance) == 0x000098, "Member 'UMovieGraphPipeline::PendingTimeStepInstance' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, GraphTimeStepInstance) == 0x0000A0, "Member 'UMovieGraphPipeline::GraphTimeStepInstance' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, GraphRendererInstance) == 0x0000A8, "Member 'UMovieGraphPipeline::GraphRendererInstance' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, GraphDataSourceInstance) == 0x0000B0, "Member 'UMovieGraphPipeline::GraphDataSourceInstance' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, GraphAudioRendererInstance) == 0x0000B8, "Member 'UMovieGraphPipeline::GraphAudioRendererInstance' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, PostRenderEvaluatedGraph) == 0x0000C0, "Member 'UMovieGraphPipeline::PostRenderEvaluatedGraph' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, CurrentJob) == 0x0000C8, "Member 'UMovieGraphPipeline::CurrentJob' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, CurrentJobDuplicate) == 0x0000D0, "Member 'UMovieGraphPipeline::CurrentJobDuplicate' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, ActiveShotList) == 0x0000D8, "Member 'UMovieGraphPipeline::ActiveShotList' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, PreviewWidgetClassToUse) == 0x0000E8, "Member 'UMovieGraphPipeline::PreviewWidgetClassToUse' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, PreviewWidget) == 0x0000F0, "Member 'UMovieGraphPipeline::PreviewWidget' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, CurrentScriptInstances) == 0x0000F8, "Member 'UMovieGraphPipeline::CurrentScriptInstances' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, OutputNodesDataSentTo) == 0x000108, "Member 'UMovieGraphPipeline::OutputNodesDataSentTo' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, CustomEngineTimeStep) == 0x0001C8, "Member 'UMovieGraphPipeline::CustomEngineTimeStep' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, PrevCustomEngineTimeStep) == 0x0001D0, "Member 'UMovieGraphPipeline::PrevCustomEngineTimeStep' has a wrong offset!");
...
{
public:
	TSubclassOf<class UMovieGraphSettingNode>     NodeType;                                          // 0x00A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieGraphRemoveRenderSettingNode) == 0x0000A8, "Wrong size on UMovieGraphRemoveRenderSettingNode");
static_assert(offsetof(UMovieGraphRemoveRenderSettingNode, NodeType) == 0x0000A0, "Member 'UMovieGraphRemoveRenderSettingNode::NodeType' has a wrong offset!");
...
static_assert(sizeof(UMovieGraphRenderLayerNode) == 0x0000B8, "Wrong size on UMovieGraphRenderLayerNode");
static_assert(offsetof(UMovieGraphRenderLayerNode, LayerName) == 0x0000A8, "Member 'UMovieGraphRenderLayerNode::LayerName' has a wrong offset!");
...
{
public:
	uint8                                         bOverride_SamplingMethodClass : 1;                 // 0x00A0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_TemporalSampleCount : 1;                 // 0x00A0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_A1[0x7];                                       // 0x00A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSoftClassPath                         SamplingMethodClass;                               // 0x00A8(0x0020)(ZeroConstructor, NoClear, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TemporalSampleCount;                               // 0x00C8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieGraphSamplingMethodNode) == 0x0000D0, "Wrong size on UMovieGraphSamplingMethodNode");
static_assert(offsetof(UMovieGraphSamplingMethodNode, SamplingMethodClass) == 0x0000A8, "Member 'UMovieGraphSamplingMethodNode::SamplingMethodClass' has a wrong offset!");
static_assert(offsetof(UMovieGraphSamplingMethodNode, TemporalSampleCount) == 0x0000C8, "Member 'UMovieGraphSamplingMethodNode::TemporalSampleCount' has a wrong offset!");
...
{
public:
	class UMovieGraphValueContainer*              SelectOptions;                                     // 0x00A0(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMovieGraphValueContainer*              SelectedOption;                                    // 0x00A8(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieGraphSelectNode) == 0x0000B0, "Wrong size on UMovieGraphSelectNode");
static_assert(offsetof(UMovieGraphSelectNode, SelectOptions) == 0x0000A0, "Member 'UMovieGraphSelectNode::SelectOptions' has a wrong offset!");
...
{
public:
	uint8                                         bOverride_Name : 1;                                // 0x00A0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_Value : 1;                               // 0x00A0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_A1[0x7];                                       // 0x00A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 Name_0;                                            // 0x00A8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Value;                                             // 0x00B8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMovieGraphSetCVarValueNode, Name_0) == 0x0000A8, "Member 'UMovieGraphSetCVarValueNode::Name_0' has a wrong offset!");
static_assert(offsetof(UMovieGraphSetCVarValueNode, Value) == 0x0000B8, "Member 'UMovieGraphSetCVarValueNode::Value' has a wrong offset!");
...
{
public:
	TSoftObjectPtr<class UMovieGraphConfig>       SubgraphAsset;                                     // 0x00A0(0x0028)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieGraphSubgraphNode, SubgraphAsset) == 0x0000A0, "Member 'UMovieGraphSubgraphNode::SubgraphAsset' has a wrong offset!");
...
static_assert(sizeof(UMovieGraphUIRendererNode) == 0x000118, "Wrong size on UMovieGraphUIRendererNode");
...
{
public:
	class UMovieGraphVariable*                    GraphVariable;                                     // 0x00A0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FMovieGraphPinProperties               OutputPin;                                         // 0x00A8(0x0020)(Transient, NoDestructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieGraphVariableNode) == 0x0000C8, "Wrong size on UMovieGraphVariableNode");
static_assert(offsetof(UMovieGraphVariableNode, GraphVariable) == 0x0000A0, "Member 'UMovieGraphVariableNode::GraphVariable' has a wrong offset!");
static_assert(offsetof(UMovieGraphVariableNode, OutputPin) == 0x0000A8, "Member 'UMovieGraphVariableNode::OutputPin' has a wrong offset!");
...
{
public:
	uint8                                         bOverride_NumWarmUpFrames : 1;                     // 0x00A0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bEmulateMotionBlur : 1;                  // 0x00A0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_A1[0x3];                                       // 0x00A1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         NumWarmUpFrames;                                   // 0x00A4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEmulateMotionBlur;                                // 0x00A8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieGraphWarmUpSettingNode) == 0x0000B0, "Wrong size on UMovieGraphWarmUpSettingNode");
static_assert(offsetof(UMovieGraphWarmUpSettingNode, NumWarmUpFrames) == 0x0000A4, "Member 'UMovieGraphWarmUpSettingNode::NumWarmUpFrames' has a wrong offset!");
static_assert(offsetof(UMovieGraphWarmUpSettingNode, bEmulateMotionBlur) == 0x0000A8, "Member 'UMovieGraphWarmUpSettingNode::bEmulateMotionBlur' has a wrong offset!");
...
static_assert(sizeof(UMovieRenderDebugWidget) == 0x0002F8, "Wrong size on UMovieRenderDebugWidget");
...
static_assert(sizeof(UMovieGraphRenderPreviewWidget) == 0x0002F8, "Wrong size on UMovieGraphRenderPreviewWidget");
...
{
public:
	FMulticastInlineDelegateProperty_             OnMoviePipelineFinishedDelegate;                   // 0x0088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class UMoviePipelineCustomTimeStep*           CustomTimeStep;                                    // 0x0098(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_A0[0x10];                                      // 0x00A0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UEngineCustomTimeStep*                  CachedPrevCustomTimeStep;                          // 0x00B0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class ULevelSequence*                         TargetSequence;                                    // 0x00B8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class ALevelSequenceActor*                    LevelSequenceActor;                                // 0x00C0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMovieRenderDebugWidget*                DebugWidget;                                       // 0x00C8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UTexture*                               PreviewTexture;                                    // 0x00D0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	class UMoviePipelineExecutorJob*              CurrentJob;                                        // 0x0350(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoviePipeline) == 0x000438, "Wrong size on UMoviePipeline");
static_assert(offsetof(UMoviePipeline, OnMoviePipelineFinishedDelegate) == 0x000088, "Member 'UMoviePipeline::OnMoviePipelineFinishedDelegate' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, CustomTimeStep) == 0x000098, "Member 'UMoviePipeline::CustomTimeStep' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, CachedPrevCustomTimeStep) == 0x0000B0, "Member 'UMoviePipeline::CachedPrevCustomTimeStep' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, TargetSequence) == 0x0000B8, "Member 'UMoviePipeline::TargetSequence' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, LevelSequenceActor) == 0x0000C0, "Member 'UMoviePipeline::LevelSequenceActor' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, DebugWidget) == 0x0000C8, "Member 'UMoviePipeline::DebugWidget' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, PreviewTexture) == 0x0000D0, "Member 'UMoviePipeline::PreviewTexture' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, DebugWidgetClass) == 0x000340, "Member 'UMoviePipeline::DebugWidgetClass' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, CurrentJob) == 0x000350, "Member 'UMoviePipeline::CurrentJob' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             SocketMessageRecievedDelegate;                     // 0x0090(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	FMulticastInlineDelegateProperty_             HTTPResponseRecievedDelegate;                      // 0x00A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TSubclassOf<class UMovieRenderDebugWidget>    DebugWidgetClass;                                  // 0x00B0(0x0008)(BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B8[0x10];                                      // 0x00B8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 UserData;                                          // 0x00C8(0x0010)(BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UMoviePipeline>             TargetPipelineClass;                               // 0x00D8(0x0008)(BlueprintVisible, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMoviePipelineExecutorBase) == 0x000128, "Wrong size on UMoviePipelineExecutorBase");
...
static_assert(offsetof(UMoviePipelineExecutorBase, SocketMessageRecievedDelegate) == 0x000090, "Member 'UMoviePipelineExecutorBase::SocketMessageRecievedDelegate' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorBase, HTTPResponseRecievedDelegate) == 0x0000A0, "Member 'UMoviePipelineExecutorBase::HTTPResponseRecievedDelegate' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorBase, DebugWidgetClass) == 0x0000B0, "Member 'UMoviePipelineExecutorBase::DebugWidgetClass' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorBase, UserData) == 0x0000C8, "Member 'UMoviePipelineExecutorBase::UserData' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorBase, TargetPipelineClass) == 0x0000D8, "Member 'UMoviePipelineExecutorBase::TargetPipelineClass' has a wrong offset!");
...
{
public:
	class UMoviePipelineQueue*                    Queue;                                             // 0x0128(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMoviePipelineBase*                     ActiveMoviePipeline;                               // 0x0130(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMoviePipelineLinearExecutorBase) == 0x000150, "Wrong size on UMoviePipelineLinearExecutorBase");
static_assert(offsetof(UMoviePipelineLinearExecutorBase, Queue) == 0x000128, "Member 'UMoviePipelineLinearExecutorBase::Queue' has a wrong offset!");
static_assert(offsetof(UMoviePipelineLinearExecutorBase, ActiveMoviePipeline) == 0x000130, "Member 'UMoviePipelineLinearExecutorBase::ActiveMoviePipeline' has a wrong offset!");
...
{
public:
	bool                                          bUseCurrentLevel;                                  // 0x0150(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_151[0x4F];                                     // 0x0151(0x004F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMoviePipelineInProcessExecutor) == 0x0001A0, "Wrong size on UMoviePipelineInProcessExecutor");
static_assert(offsetof(UMoviePipelineInProcessExecutor, bUseCurrentLevel) == 0x000150, "Member 'UMoviePipelineInProcessExecutor::bUseCurrentLevel' has a wrong offset!");
...
{
public:
	TSubclassOf<class UMoviePipelinePythonHostExecutor> ExecutorClass;                                     // 0x0128(0x0008)(BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMoviePipelineQueue*                    PipelineQueue;                                     // 0x0130(0x0008)(BlueprintVisible, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UWorld*                                 LastLoadedWorld;                                   // 0x0138(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoviePipelinePythonHostExecutor) == 0x000140, "Wrong size on UMoviePipelinePythonHostExecutor");
static_assert(offsetof(UMoviePipelinePythonHostExecutor, ExecutorClass) == 0x000128, "Member 'UMoviePipelinePythonHostExecutor::ExecutorClass' has a wrong offset!");
static_assert(offsetof(UMoviePipelinePythonHostExecutor, PipelineQueue) == 0x000130, "Member 'UMoviePipelinePythonHostExecutor::PipelineQueue' has a wrong offset!");
static_assert(offsetof(UMoviePipelinePythonHostExecutor, LastLoadedWorld) == 0x000138, "Member 'UMoviePipelinePythonHostExecutor::LastLoadedWorld' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_60[0xE8];                                      // 0x0060(0x00E8)(Fixing Size After Last Property [ Dumper-7 ])
	...
	TSoftObjectPtr<class UMoviePipelineShotConfig> ShotOverridePresetOrigin;                          // 0x0168(0x0028)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSoftObjectPtr<class UMovieGraphConfig>       GraphPreset;                                       // 0x0190(0x0028)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UMovieJobVariableAssignmentContainer*> GraphVariableAssignments;                          // 0x01B8(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<class UMovieJobVariableAssignmentContainer*> PrimaryGraphVariableAssignments;                   // 0x01C8(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoviePipelineExecutorShot) == 0x0001D8, "Wrong size on UMoviePipelineExecutorShot");
...
static_assert(offsetof(UMoviePipelineExecutorShot, Progress) == 0x000148, "Member 'UMoviePipelineExecutorShot::Progress' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorShot, StatusMessage) == 0x000150, "Member 'UMoviePipelineExecutorShot::StatusMessage' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorShot, ShotOverrideConfig) == 0x000160, "Member 'UMoviePipelineExecutorShot::ShotOverrideConfig' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorShot, ShotOverridePresetOrigin) == 0x000168, "Member 'UMoviePipelineExecutorShot::ShotOverridePresetOrigin' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorShot, GraphPreset) == 0x000190, "Member 'UMoviePipelineExecutorShot::GraphPreset' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorShot, GraphVariableAssignments) == 0x0001B8, "Member 'UMoviePipelineExecutorShot::GraphVariableAssignments' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorShot, PrimaryGraphVariableAssignments) == 0x0001C8, "Member 'UMoviePipelineExecutorShot::PrimaryGraphVariableAssignments' has a wrong offset!");
...
public:
	...
	TSoftObjectPtr<class UMoviePipelinePrimaryConfig> PresetOrigin;                                      // 0x00F8(0x0028)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bEnabled;                                          // 0x0120(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_121[0x7];                                      // 0x0121(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftObjectPtr<class UMovieGraphConfig>       GraphPreset;                                       // 0x0128(0x0028)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UMovieJobVariableAssignmentContainer*> GraphVariableAssignments;                          // 0x0150(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoviePipelineExecutorJob) == 0x000160, "Wrong size on UMoviePipelineExecutorJob");
...
static_assert(offsetof(UMoviePipelineExecutorJob, bEnabled) == 0x000120, "Member 'UMoviePipelineExecutorJob::bEnabled' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorJob, GraphPreset) == 0x000128, "Member 'UMoviePipelineExecutorJob::GraphPreset' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorJob, GraphVariableAssignments) == 0x000150, "Member 'UMoviePipelineExecutorJob::GraphVariableAssignments' has a wrong offset!");
