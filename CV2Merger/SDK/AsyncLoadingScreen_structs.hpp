...
static_assert(offsetof(FTextAppearance, ShadowOffset) == 0x000078, "Member 'FTextAppearance::ShadowOffset' has a wrong offset!");
...
static_assert(offsetof(FLoadingWidgetSettings, bLoadingTextRightPosition) == 0x000048, "Member 'FLoadingWidgetSettings::bLoadingTextRightPosition' has a wrong offset!");
static_assert(offsetof(FLoadingWidgetSettings, bLoadingTextTopPosition) == 0x000049, "Member 'FLoadingWidgetSettings::bLoadingTextTopPosition' has a wrong offset!");
static_assert(offsetof(FLoadingWidgetSettings, Appearance) == 0x000050, "Member 'FLoadingWidgetSettings::Appearance' has a wrong offset!");
...
static_assert(offsetof(FLoadingCompleteTextSettings, Appearance) == 0x000010, "Member 'FLoadingCompleteTextSettings::Appearance' has a wrong offset!");
...
public:
	...
	struct FLoadingWidgetSettings                 LoadingWidget;                                     // 0x01F0(0x02F0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	EAsyncLoadingScreenLayout                     Layout;                                            // 0x04E0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FALoadingScreenSettings) == 0x0004F0, "Wrong size on FALoadingScreenSettings");
...
static_assert(offsetof(FALoadingScreenSettings, Layout) == 0x0004E0, "Member 'FALoadingScreenSettings::Layout' has a wrong offset!");
...
// ScriptStruct AsyncLoadingScreen.PlainBackgroundSettings
// 0x0014 (0x0014 - 0x0000)
struct alignas(0x04) FPlainBackgroundSettings final
{
public:
	uint8                                         Pad_0[0x14];                                       // 0x0000(0x0014)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPlainBackgroundSettings) == 0x000004, "Wrong alignment on FPlainBackgroundSettings");
static_assert(sizeof(FPlainBackgroundSettings) == 0x000014, "Wrong size on FPlainBackgroundSettings");
