...
static_assert(offsetof(UNavigationSystemV1, OperationMode) == 0x000228, "Member 'UNavigationSystemV1::OperationMode' has a wrong offset!");
...
static_assert(sizeof(ARecastNavMesh) == 0x0006A0, "Wrong size on ARecastNavMesh");
