...
static_assert(sizeof(AsyncAction_CommonUserInitialize_HandleInitializationComplete) == 0x000028, "Wrong size on AsyncAction_CommonUserInitialize_HandleInitializationComplete");
...
static_assert(offsetof(AsyncAction_CommonUserInitialize_HandleInitializationComplete, RequestedPrivilege) == 0x000020, "Member 'AsyncAction_CommonUserInitialize_HandleInitializationComplete::RequestedPrivilege' has a wrong offset!");
static_assert(offsetof(AsyncAction_CommonUserInitialize_HandleInitializationComplete, OnlineContext) == 0x000021, "Member 'AsyncAction_CommonUserInitialize_HandleInitializationComplete::OnlineContext' has a wrong offset!");
...
static_assert(alignof(CommonUserInfo_IsDoingLogin) == 0x000001, "Wrong alignment on CommonUserInfo_IsDoingLogin");
static_assert(sizeof(CommonUserInfo_IsDoingLogin) == 0x000001, "Wrong size on CommonUserInfo_IsDoingLogin");
static_assert(offsetof(CommonUserInfo_IsDoingLogin, ReturnValue) == 0x000000, "Member 'CommonUserInfo_IsDoingLogin::ReturnValue' has a wrong offset!");
...
static_assert(alignof(CommonUserInfo_IsLoggedIn) == 0x000001, "Wrong alignment on CommonUserInfo_IsLoggedIn");
static_assert(sizeof(CommonUserInfo_IsLoggedIn) == 0x000001, "Wrong size on CommonUserInfo_IsLoggedIn");
static_assert(offsetof(CommonUserInfo_IsLoggedIn, ReturnValue) == 0x000000, "Member 'CommonUserInfo_IsLoggedIn::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(CommonUserSubsystem_SendSystemMessage) == 0x000028, "Wrong size on CommonUserSubsystem_SendSystemMessage");
...
static_assert(offsetof(CommonUserSubsystem_SendSystemMessage, BodyText) == 0x000018, "Member 'CommonUserSubsystem_SendSystemMessage::BodyText' has a wrong offset!");
...
static_assert(alignof(CommonUserSubsystem_TryToLogOutUser) == 0x000004, "Wrong alignment on CommonUserSubsystem_TryToLogOutUser");
static_assert(sizeof(CommonUserSubsystem_TryToLogOutUser) == 0x000008, "Wrong size on CommonUserSubsystem_TryToLogOutUser");
static_assert(offsetof(CommonUserSubsystem_TryToLogOutUser, LocalPlayerIndex) == 0x000000, "Member 'CommonUserSubsystem_TryToLogOutUser::LocalPlayerIndex' has a wrong offset!");
static_assert(offsetof(CommonUserSubsystem_TryToLogOutUser, bDestroyPlayer) == 0x000004, "Member 'CommonUserSubsystem_TryToLogOutUser::bDestroyPlayer' has a wrong offset!");
static_assert(offsetof(CommonUserSubsystem_TryToLogOutUser, ReturnValue) == 0x000005, "Member 'CommonUserSubsystem_TryToLogOutUser::ReturnValue' has a wrong offset!");
