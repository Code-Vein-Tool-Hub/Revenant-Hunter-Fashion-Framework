...
// Function MovieScene.MovieSceneSequencePlayer.PlayWithFrameRate
// 0x0008 (0x0008 - 0x0000)
struct MovieSceneSequencePlayer_PlayWithFrameRate final
{
public:
...
static_assert(alignof(MovieSceneSequencePlayer_PlayWithFrameRate) == 0x000004, "Wrong alignment on MovieSceneSequencePlayer_PlayWithFrameRate");
static_assert(sizeof(MovieSceneSequencePlayer_PlayWithFrameRate) == 0x000008, "Wrong size on MovieSceneSequencePlayer_PlayWithFrameRate");
static_assert(offsetof(MovieSceneSequencePlayer_PlayWithFrameRate, FrameRate) == 0x000000, "Member 'MovieSceneSequencePlayer_PlayWithFrameRate::FrameRate' has a wrong offset!");
