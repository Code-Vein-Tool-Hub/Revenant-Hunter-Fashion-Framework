...
public:
	...
	class UMirrorDataTable*                       MirrorDataTable;                                   // 0x00F0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAnimNode_ChooserPlayer) == 0x000240, "Wrong size on FAnimNode_ChooserPlayer");
static_assert(offsetof(FAnimNode_ChooserPlayer, EvaluationFrequency) == 0x0000D8, "Member 'FAnimNode_ChooserPlayer::EvaluationFrequency' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChooserPlayer, Chooser) == 0x0000E0, "Member 'FAnimNode_ChooserPlayer::Chooser' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChooserPlayer, MirrorDataTable) == 0x0000F0, "Member 'FAnimNode_ChooserPlayer::MirrorDataTable' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChooserPlayer, BlendSpaceX) == 0x0000F8, "Member 'FAnimNode_ChooserPlayer::BlendSpaceX' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChooserPlayer, BlendSpaceY) == 0x0000FC, "Member 'FAnimNode_ChooserPlayer::BlendSpaceY' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChooserPlayer, DefaultSettings) == 0x000108, "Member 'FAnimNode_ChooserPlayer::DefaultSettings' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChooserPlayer, ChooserContextDefinition) == 0x000148, "Member 'FAnimNode_ChooserPlayer::ChooserContextDefinition' has a wrong offset!");
static_assert(offsetof(FAnimNode_ChooserPlayer, bStartFromMatchingPose) == 0x000158, "Member 'FAnimNode_ChooserPlayer::bStartFromMatchingPose' has a wrong offset!");
