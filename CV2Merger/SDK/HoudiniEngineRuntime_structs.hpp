...
enum class EHoudiniInputObjectType : uint8
{
	...
	PackedLevelActor                         = 27,
	SplineRiver                              = 28,
	EHoudiniInputObjectType_MAX              = 29,
};
...
public:
	...
	bool                                          bExportEditLayers;                                 // 0x0020(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_21[0x3];                                       // 0x0021(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FHoudiniInputObjectSettings) == 0x000004, "Wrong alignment on FHoudiniInputObjectSettings");
static_assert(sizeof(FHoudiniInputObjectSettings) == 0x000024, "Wrong size on FHoudiniInputObjectSettings");
...
static_assert(offsetof(FHoudiniInputObjectSettings, bExportEditLayers) == 0x000020, "Member 'FHoudiniInputObjectSettings::bExportEditLayers' has a wrong offset!");
