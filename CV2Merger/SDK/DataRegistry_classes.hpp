...
static_assert(sizeof(UDataRegistry) == 0x0000C8, "Wrong size on UDataRegistry");
...
static_assert(sizeof(UDataRegistrySubsystem) == 0x0000E8, "Wrong size on UDataRegistrySubsystem");
