...
public:
	...
	struct FGameplayAbilityActivationInfo         CurrentActivationInfo;                             // 0x0100(0x0018)(BlueprintVisible, BlueprintReadOnly, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FGameplayEventData                     CurrentEventData;                                  // 0x0118(0x00B0)(BlueprintVisible, BlueprintReadOnly, Protected, NativeAccessSpecifierProtected)
	...
	EGameplayAbilityNetSecurityPolicy             NetSecurityPolicy;                                 // 0x01C9(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1CA[0x6];                                      // 0x01CA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UGameplayEffect>            CostGameplayEffectClass;                           // 0x01D0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	TSubclassOf<class UGameplayEffect>            CooldownGameplayEffectClass;                       // 0x01E8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  CancelAbilitiesWithTag;                            // 0x01F0(0x0020)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  BlockAbilitiesWithTag;                             // 0x0210(0x0020)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  ActivationOwnedTags;                               // 0x0230(0x0020)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  ActivationRequiredTags;                            // 0x0250(0x0020)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  ActivationBlockedTags;                             // 0x0270(0x0020)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  SourceRequiredTags;                                // 0x0290(0x0020)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  SourceBlockedTags;                                 // 0x02B0(0x0020)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  TargetRequiredTags;                                // 0x02D0(0x0020)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  TargetBlockedTags;                                 // 0x02F0(0x0020)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_310[0x20];                                     // 0x0310(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UGameplayTask*>                  ActiveTasks;                                       // 0x0330(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_340[0x10];                                     // 0x0340(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UAnimMontage*                           CurrentMontage;                                    // 0x0350(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_358[0x60];                                     // 0x0358(0x0060)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bIsActive;                                         // 0x03B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsAbilityEnding;                                  // 0x03B9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsCancelable;                                     // 0x03BA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsBlockingOtherAbilities;                         // 0x03BB(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3BC[0x14];                                     // 0x03BC(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bMarkPendingKillOnAbilityEnd;                      // 0x03D0(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGameplayAbility) == 0x0003D8, "Wrong size on UGameplayAbility");
...
static_assert(offsetof(UGameplayAbility, CurrentEventData) == 0x000118, "Member 'UGameplayAbility::CurrentEventData' has a wrong offset!");
...
static_assert(offsetof(UGameplayAbility, NetSecurityPolicy) == 0x0001C9, "Member 'UGameplayAbility::NetSecurityPolicy' has a wrong offset!");
...
static_assert(offsetof(UGameplayAbility, CancelAbilitiesWithTag) == 0x0001F0, "Member 'UGameplayAbility::CancelAbilitiesWithTag' has a wrong offset!");
static_assert(offsetof(UGameplayAbility, BlockAbilitiesWithTag) == 0x000210, "Member 'UGameplayAbility::BlockAbilitiesWithTag' has a wrong offset!");
static_assert(offsetof(UGameplayAbility, ActivationOwnedTags) == 0x000230, "Member 'UGameplayAbility::ActivationOwnedTags' has a wrong offset!");
static_assert(offsetof(UGameplayAbility, ActivationRequiredTags) == 0x000250, "Member 'UGameplayAbility::ActivationRequiredTags' has a wrong offset!");
static_assert(offsetof(UGameplayAbility, ActivationBlockedTags) == 0x000270, "Member 'UGameplayAbility::ActivationBlockedTags' has a wrong offset!");
static_assert(offsetof(UGameplayAbility, SourceRequiredTags) == 0x000290, "Member 'UGameplayAbility::SourceRequiredTags' has a wrong offset!");
static_assert(offsetof(UGameplayAbility, SourceBlockedTags) == 0x0002B0, "Member 'UGameplayAbility::SourceBlockedTags' has a wrong offset!");
static_assert(offsetof(UGameplayAbility, TargetRequiredTags) == 0x0002D0, "Member 'UGameplayAbility::TargetRequiredTags' has a wrong offset!");
static_assert(offsetof(UGameplayAbility, TargetBlockedTags) == 0x0002F0, "Member 'UGameplayAbility::TargetBlockedTags' has a wrong offset!");
static_assert(offsetof(UGameplayAbility, ActiveTasks) == 0x000330, "Member 'UGameplayAbility::ActiveTasks' has a wrong offset!");
static_assert(offsetof(UGameplayAbility, CurrentMontage) == 0x000350, "Member 'UGameplayAbility::CurrentMontage' has a wrong offset!");
static_assert(offsetof(UGameplayAbility, bIsActive) == 0x0003B8, "Member 'UGameplayAbility::bIsActive' has a wrong offset!");
static_assert(offsetof(UGameplayAbility, bIsAbilityEnding) == 0x0003B9, "Member 'UGameplayAbility::bIsAbilityEnding' has a wrong offset!");
static_assert(offsetof(UGameplayAbility, bIsCancelable) == 0x0003BA, "Member 'UGameplayAbility::bIsCancelable' has a wrong offset!");
static_assert(offsetof(UGameplayAbility, bIsBlockingOtherAbilities) == 0x0003BB, "Member 'UGameplayAbility::bIsBlockingOtherAbilities' has a wrong offset!");
static_assert(offsetof(UGameplayAbility, bMarkPendingKillOnAbilityEnd) == 0x0003D0, "Member 'UGameplayAbility::bMarkPendingKillOnAbilityEnd' has a wrong offset!");
...
static_assert(sizeof(UGameplayAbility_CharacterJump) == 0x0003D8, "Wrong size on UGameplayAbility_CharacterJump");
...
{
public:
	class UAnimMontage*                           MontageToPlay;                                     // 0x03D8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PlayRate;                                          // 0x03E0(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   SectionName;                                       // 0x03E4(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3EC[0x4];                                      // 0x03EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TSubclassOf<class UGameplayEffect>>    GameplayEffectClassesWhileAnimating;               // 0x03F0(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<class UGameplayEffect*>                GameplayEffectsWhileAnimating;                     // 0x0400(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, EditConst, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGameplayAbility_Montage) == 0x000410, "Wrong size on UGameplayAbility_Montage");
static_assert(offsetof(UGameplayAbility_Montage, MontageToPlay) == 0x0003D8, "Member 'UGameplayAbility_Montage::MontageToPlay' has a wrong offset!");
static_assert(offsetof(UGameplayAbility_Montage, PlayRate) == 0x0003E0, "Member 'UGameplayAbility_Montage::PlayRate' has a wrong offset!");
static_assert(offsetof(UGameplayAbility_Montage, SectionName) == 0x0003E4, "Member 'UGameplayAbility_Montage::SectionName' has a wrong offset!");
static_assert(offsetof(UGameplayAbility_Montage, GameplayEffectClassesWhileAnimating) == 0x0003F0, "Member 'UGameplayAbility_Montage::GameplayEffectClassesWhileAnimating' has a wrong offset!");
static_assert(offsetof(UGameplayAbility_Montage, GameplayEffectsWhileAnimating) == 0x000400, "Member 'UGameplayAbility_Montage::GameplayEffectsWhileAnimating' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_140[0x208];                                    // 0x0140(0x0208)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         OutgoingDuration;                                  // 0x0348(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         IncomingDuration;                                  // 0x034C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_350[0x20];                                     // 0x0350(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FString>                         ClientDebugStrings;                                // 0x0370(0x0010)(Net, ZeroConstructor, RepNotify, NativeAccessSpecifierPublic)
	TArray<class FString>                         ServerDebugStrings;                                // 0x0380(0x0010)(Net, ZeroConstructor, RepNotify, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_3EC[0x4];                                      // 0x03EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AGameplayAbilityTargetActor*>    SpawnedTargetActors;                               // 0x03F0(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	uint8                                         Pad_400[0x28];                                     // 0x0400(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 OwnerActor;                                        // 0x0428(0x0008)(Net, ZeroConstructor, RepNotify, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class AActor*                                 AvatarActor;                                       // 0x0430(0x0008)(Net, ZeroConstructor, RepNotify, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_438[0x10];                                     // 0x0438(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayAbilitySpecContainer          ActivatableAbilities;                              // 0x0448(0x0120)(BlueprintVisible, BlueprintReadOnly, Net, Transient, RepNotify, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	...
	struct FGameplayAbilityRepAnimMontage         RepAnimMontageInfo;                                // 0x07C8(0x0040)(Net, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
	...
	struct FGameplayAbilityLocalAnimMontage       LocalAnimMontageInfo;                              // 0x0810(0x0028)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_838[0xA0];                                     // 0x0838(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
	struct FActiveGameplayEffectsContainer        ActiveGameplayEffects;                             // 0x08D8(0x0308)(Net, Protected, NativeAccessSpecifierProtected)
	struct FActiveGameplayCueContainer            ActiveGameplayCues;                                // 0x0BE0(0x0128)(Net, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FActiveGameplayCueContainer            MinimalReplicationGameplayCues;                    // 0x0D08(0x0128)(Net, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_E30[0x130];                                    // 0x0E30(0x0130)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<uint8>                                 BlockedAbilityBindings;                            // 0x0F60(0x0010)(Net, ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_F70[0x130];                                    // 0x0F70(0x0130)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMinimalReplicationTagCountMap         MinimalReplicationTags;                            // 0x10A0(0x0068)(Net, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<class UAttributeSet*>                  SpawnedAttributes;                                 // 0x1108(0x0010)(ExportObject, Net, ZeroConstructor, Transient, RepNotify, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1118[0x10];                                    // 0x1118(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMinimalReplicationTagCountMap         ReplicatedLooseTags;                               // 0x1128(0x0068)(Net, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1190[0x8];                                     // 0x1190(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FReplicatedPredictionKeyMap            ReplicatedPredictionKeyMap;                        // 0x1198(0x0118)(Net, Transient, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAbilitySystemComponent) == 0x0012C0, "Wrong size on UAbilitySystemComponent");
...
static_assert(offsetof(UAbilitySystemComponent, OutgoingDuration) == 0x000348, "Member 'UAbilitySystemComponent::OutgoingDuration' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, IncomingDuration) == 0x00034C, "Member 'UAbilitySystemComponent::IncomingDuration' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, ClientDebugStrings) == 0x000370, "Member 'UAbilitySystemComponent::ClientDebugStrings' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, ServerDebugStrings) == 0x000380, "Member 'UAbilitySystemComponent::ServerDebugStrings' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, UserAbilityActivationInhibited) == 0x0003E8, "Member 'UAbilitySystemComponent::UserAbilityActivationInhibited' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, ReplicationProxyEnabled) == 0x0003E9, "Member 'UAbilitySystemComponent::ReplicationProxyEnabled' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, bSuppressGrantAbility) == 0x0003EA, "Member 'UAbilitySystemComponent::bSuppressGrantAbility' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, bSuppressGameplayCues) == 0x0003EB, "Member 'UAbilitySystemComponent::bSuppressGameplayCues' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, SpawnedTargetActors) == 0x0003F0, "Member 'UAbilitySystemComponent::SpawnedTargetActors' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, OwnerActor) == 0x000428, "Member 'UAbilitySystemComponent::OwnerActor' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, AvatarActor) == 0x000430, "Member 'UAbilitySystemComponent::AvatarActor' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, ActivatableAbilities) == 0x000448, "Member 'UAbilitySystemComponent::ActivatableAbilities' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, AllReplicatedInstancedAbilities) == 0x000598, "Member 'UAbilitySystemComponent::AllReplicatedInstancedAbilities' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, RepAnimMontageInfo) == 0x0007C8, "Member 'UAbilitySystemComponent::RepAnimMontageInfo' has a wrong offset!");
...
static_assert(offsetof(UAbilitySystemComponent, ActiveGameplayEffects) == 0x0008D8, "Member 'UAbilitySystemComponent::ActiveGameplayEffects' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, ActiveGameplayCues) == 0x000BE0, "Member 'UAbilitySystemComponent::ActiveGameplayCues' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, MinimalReplicationGameplayCues) == 0x000D08, "Member 'UAbilitySystemComponent::MinimalReplicationGameplayCues' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, BlockedAbilityBindings) == 0x000F60, "Member 'UAbilitySystemComponent::BlockedAbilityBindings' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, MinimalReplicationTags) == 0x0010A0, "Member 'UAbilitySystemComponent::MinimalReplicationTags' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, SpawnedAttributes) == 0x001108, "Member 'UAbilitySystemComponent::SpawnedAttributes' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, ReplicatedLooseTags) == 0x001128, "Member 'UAbilitySystemComponent::ReplicatedLooseTags' has a wrong offset!");
...
public:
	...
	bool                                          bUseDebugTargetFromHud;                            // 0x0078(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UCurveTable*                            GlobalCurveTable;                                  // 0x0178(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UDataTable*                             GlobalAttributeMetaDataTable;                      // 0x01A0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	TArray<struct FSoftObjectPath>                GlobalAttributeSetDefaultsTableNames;              // 0x01C8(0x0010)(ZeroConstructor, Config, Protected, NativeAccessSpecifierProtected)
	TArray<class UCurveTable*>                    GlobalAttributeDefaultsTables;                     // 0x01D8(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	...
	class UGameplayTagReponseTable*               GameplayTagResponseTable;                          // 0x0258(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UGameplayCueManager*                    GlobalGameplayCueManager;                          // 0x0268(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UAbilitySystemGlobals, bUseDebugTargetFromHud) == 0x000078, "Member 'UAbilitySystemGlobals::bUseDebugTargetFromHud' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailIsDeadTag) == 0x00007C, "Member 'UAbilitySystemGlobals::ActivateFailIsDeadTag' has a wrong offset!");
...
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailCooldownTag) == 0x00008C, "Member 'UAbilitySystemGlobals::ActivateFailCooldownTag' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailCooldownName) == 0x000094, "Member 'UAbilitySystemGlobals::ActivateFailCooldownName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailCostTag) == 0x00009C, "Member 'UAbilitySystemGlobals::ActivateFailCostTag' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailCostName) == 0x0000A4, "Member 'UAbilitySystemGlobals::ActivateFailCostName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailTagsBlockedTag) == 0x0000AC, "Member 'UAbilitySystemGlobals::ActivateFailTagsBlockedTag' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailTagsBlockedName) == 0x0000B4, "Member 'UAbilitySystemGlobals::ActivateFailTagsBlockedName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailTagsMissingTag) == 0x0000BC, "Member 'UAbilitySystemGlobals::ActivateFailTagsMissingTag' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailTagsMissingName) == 0x0000C4, "Member 'UAbilitySystemGlobals::ActivateFailTagsMissingName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailNetworkingTag) == 0x0000CC, "Member 'UAbilitySystemGlobals::ActivateFailNetworkingTag' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ActivateFailNetworkingName) == 0x0000D4, "Member 'UAbilitySystemGlobals::ActivateFailNetworkingName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, MinimalReplicationTagCountBits) == 0x0000DC, "Member 'UAbilitySystemGlobals::MinimalReplicationTagCountBits' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, TargetDataStructCache) == 0x0000E0, "Member 'UAbilitySystemGlobals::TargetDataStructCache' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, EffectContextStructCache) == 0x0000F0, "Member 'UAbilitySystemGlobals::EffectContextStructCache' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, bAllowGameplayModEvaluationChannels) == 0x000100, "Member 'UAbilitySystemGlobals::bAllowGameplayModEvaluationChannels' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, DefaultGameplayModEvaluationChannel) == 0x000101, "Member 'UAbilitySystemGlobals::DefaultGameplayModEvaluationChannel' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GameplayModEvaluationChannelAliases) == 0x000104, "Member 'UAbilitySystemGlobals::GameplayModEvaluationChannelAliases' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GlobalCurveTableName) == 0x000158, "Member 'UAbilitySystemGlobals::GlobalCurveTableName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GlobalCurveTable) == 0x000178, "Member 'UAbilitySystemGlobals::GlobalCurveTable' has a wrong offset!");
...
static_assert(offsetof(UAbilitySystemGlobals, GlobalAttributeMetaDataTable) == 0x0001A0, "Member 'UAbilitySystemGlobals::GlobalAttributeMetaDataTable' has a wrong offset!");
...
static_assert(offsetof(UAbilitySystemGlobals, GlobalAttributeSetDefaultsTableNames) == 0x0001C8, "Member 'UAbilitySystemGlobals::GlobalAttributeSetDefaultsTableNames' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GlobalAttributeDefaultsTables) == 0x0001D8, "Member 'UAbilitySystemGlobals::GlobalAttributeDefaultsTables' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GlobalGameplayCueManagerClass) == 0x0001E8, "Member 'UAbilitySystemGlobals::GlobalGameplayCueManagerClass' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GlobalGameplayCueManagerName) == 0x000208, "Member 'UAbilitySystemGlobals::GlobalGameplayCueManagerName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GameplayCueNotifyPaths) == 0x000228, "Member 'UAbilitySystemGlobals::GameplayCueNotifyPaths' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GameplayTagResponseTableName) == 0x000238, "Member 'UAbilitySystemGlobals::GameplayTagResponseTableName' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GameplayTagResponseTable) == 0x000258, "Member 'UAbilitySystemGlobals::GameplayTagResponseTable' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, PredictTargetGameplayEffects) == 0x000261, "Member 'UAbilitySystemGlobals::PredictTargetGameplayEffects' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, ReplicateActivationOwnedTags) == 0x000262, "Member 'UAbilitySystemGlobals::ReplicateActivationOwnedTags' has a wrong offset!");
static_assert(offsetof(UAbilitySystemGlobals, GlobalGameplayCueManager) == 0x000268, "Member 'UAbilitySystemGlobals::GlobalGameplayCueManager' has a wrong offset!");
...
static_assert(sizeof(UGameplayCueManager) == 0x0002D0, "Wrong size on UGameplayCueManager");
...
public:
	...
	uint8                                         Pad_EA0[0x8];                                      // 0x0EA0(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	struct FMovieSceneGameplayCueChannel          Channel;                                           // 0x0110(0x0110)(AssetRegistrySearchable, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneGameplayCueTriggerSection) == 0x000220, "Wrong size on UMovieSceneGameplayCueTriggerSection");
