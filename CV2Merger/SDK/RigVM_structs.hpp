...
static_assert(sizeof(FRigVMExtendedExecuteContext) == 0x000230, "Wrong size on FRigVMExtendedExecuteContext");
...
static_assert(sizeof(FRigVMDebugInfo) == 0x000148, "Wrong size on FRigVMDebugInfo");
