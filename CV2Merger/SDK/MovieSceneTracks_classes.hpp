...
static_assert(sizeof(UMovieSceneDoublePerlinNoiseChannelContainer) == 0x0000E0, "Wrong size on UMovieSceneDoublePerlinNoiseChannelContainer");
...
static_assert(sizeof(UMovieSceneFloatPerlinNoiseChannelContainer) == 0x0000E0, "Wrong size on UMovieSceneFloatPerlinNoiseChannelContainer");
...
static_assert(sizeof(UMovieScene3DPathSection) == 0x000250, "Wrong size on UMovieScene3DPathSection");
...
static_assert(offsetof(UMovieScene3DPathSection, FrontAxisEnum) == 0x000248, "Member 'UMovieScene3DPathSection::FrontAxisEnum' has a wrong offset!");
static_assert(offsetof(UMovieScene3DPathSection, UpAxisEnum) == 0x000249, "Member 'UMovieScene3DPathSection::UpAxisEnum' has a wrong offset!");
...
static_assert(sizeof(UMovieScene3DTransformSection) == 0x000D38, "Wrong size on UMovieScene3DTransformSection");
static_assert(offsetof(UMovieScene3DTransformSection, TransformMask) == 0x000140, "Member 'UMovieScene3DTransformSection::TransformMask' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, Translation) == 0x000148, "Member 'UMovieScene3DTransformSection::Translation' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, Rotation) == 0x0004D8, "Member 'UMovieScene3DTransformSection::Rotation' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, Scale) == 0x000868, "Member 'UMovieScene3DTransformSection::Scale' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, ManualWeight) == 0x000BF8, "Member 'UMovieScene3DTransformSection::ManualWeight' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, OverrideRegistry) == 0x000D20, "Member 'UMovieScene3DTransformSection::OverrideRegistry' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, Constraints) == 0x000D28, "Member 'UMovieScene3DTransformSection::Constraints' has a wrong offset!");
static_assert(offsetof(UMovieScene3DTransformSection, bUseQuaternionInterpolation) == 0x000D30, "Member 'UMovieScene3DTransformSection::bUseQuaternionInterpolation' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneActorReferenceSection) == 0x0002C0, "Wrong size on UMovieSceneActorReferenceSection");
...
static_assert(offsetof(UMovieSceneActorReferenceSection, ActorGuidIndexCurve) == 0x000230, "Member 'UMovieSceneActorReferenceSection::ActorGuidIndexCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneActorReferenceSection, ActorGuidStrings) == 0x0002B0, "Member 'UMovieSceneActorReferenceSection::ActorGuidStrings' has a wrong offset!");

// Class MovieSceneTracks.MovieSceneAudioSection
// 0x0580 (0x0678 - 0x00F8)
...
public:
	...
	TDelegate<void(TArray<struct FSubtitleCue>& Subtitles, float CueDuration)> OnQueueSubtitles;                                  // 0x0648(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             OnAudioFinished;                                   // 0x0658(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)
	FMulticastInlineDelegateProperty_             OnAudioPlaybackPercent;                            // 0x0668(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneAudioSection) == 0x000678, "Wrong size on UMovieSceneAudioSection");
...
static_assert(offsetof(UMovieSceneAudioSection, PitchMultiplier) == 0x000248, "Member 'UMovieSceneAudioSection::PitchMultiplier' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, Inputs_Float) == 0x000370, "Member 'UMovieSceneAudioSection::Inputs_Float' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, Inputs_String) == 0x0003C0, "Member 'UMovieSceneAudioSection::Inputs_String' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, Inputs_Bool) == 0x000410, "Member 'UMovieSceneAudioSection::Inputs_Bool' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, Inputs_Int) == 0x000460, "Member 'UMovieSceneAudioSection::Inputs_Int' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, Inputs_Trigger) == 0x0004B0, "Member 'UMovieSceneAudioSection::Inputs_Trigger' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, AttachActorData) == 0x000500, "Member 'UMovieSceneAudioSection::AttachActorData' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, bLooping) == 0x000638, "Member 'UMovieSceneAudioSection::bLooping' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, bSuppressSubtitles) == 0x000639, "Member 'UMovieSceneAudioSection::bSuppressSubtitles' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, bOverrideAttenuation) == 0x00063A, "Member 'UMovieSceneAudioSection::bOverrideAttenuation' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, AttenuationSettings) == 0x000640, "Member 'UMovieSceneAudioSection::AttenuationSettings' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, OnQueueSubtitles) == 0x000648, "Member 'UMovieSceneAudioSection::OnQueueSubtitles' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, OnAudioFinished) == 0x000658, "Member 'UMovieSceneAudioSection::OnAudioFinished' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, OnAudioPlaybackPercent) == 0x000668, "Member 'UMovieSceneAudioSection::OnAudioPlaybackPercent' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneByteSection) == 0x000220, "Wrong size on UMovieSceneByteSection");
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneCameraShakeSourceTriggerChannel Channel;                                           // 0x0100(0x0110)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneCameraShakeSourceTriggerSection) == 0x000210, "Wrong size on UMovieSceneCameraShakeSourceTriggerSection");
...
public:
	...
	class FText                                   DisplayName;                                       // 0x0150(0x0010)(Deprecated, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieSceneCinematicShotSection, ShotDisplayName) == 0x000140, "Member 'UMovieSceneCinematicShotSection::ShotDisplayName' has a wrong offset!");
static_assert(offsetof(UMovieSceneCinematicShotSection, DisplayName) == 0x000150, "Member 'UMovieSceneCinematicShotSection::DisplayName' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneColorSection) == 0x0005A0, "Wrong size on UMovieSceneColorSection");
...
static_assert(offsetof(UMovieSceneColorSection, GreenCurve) == 0x000228, "Member 'UMovieSceneColorSection::GreenCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneColorSection, BlueCurve) == 0x000350, "Member 'UMovieSceneColorSection::BlueCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneColorSection, AlphaCurve) == 0x000478, "Member 'UMovieSceneColorSection::AlphaCurve' has a wrong offset!");
...
public:
	...
	bool                                          bPerformGCOnUnload;                                // 0x0124(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieSceneDataLayerSection, bFlushOnActivated) == 0x000122, "Member 'UMovieSceneDataLayerSection::bFlushOnActivated' has a wrong offset!");
static_assert(offsetof(UMovieSceneDataLayerSection, bFlushOnUnload) == 0x000123, "Member 'UMovieSceneDataLayerSection::bFlushOnUnload' has a wrong offset!");
static_assert(offsetof(UMovieSceneDataLayerSection, bPerformGCOnUnload) == 0x000124, "Member 'UMovieSceneDataLayerSection::bPerformGCOnUnload' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneDoubleSection) == 0x000230, "Wrong size on UMovieSceneDoubleSection");
...
static_assert(sizeof(UMovieSceneEnumSection) == 0x000220, "Wrong size on UMovieSceneEnumSection");
...
static_assert(sizeof(UMovieSceneEventSection) == 0x000280, "Wrong size on UMovieSceneEventSection");
...
static_assert(sizeof(UMovieSceneEventTriggerSection) == 0x000210, "Wrong size on UMovieSceneEventTriggerSection");
...
static_assert(sizeof(UMovieSceneFadeSection) == 0x000240, "Wrong size on UMovieSceneFadeSection");
...
static_assert(offsetof(UMovieSceneFadeSection, FadeColor) == 0x000228, "Member 'UMovieSceneFadeSection::FadeColor' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneFloatSection) == 0x000238, "Wrong size on UMovieSceneFloatSection");
...
static_assert(offsetof(UMovieSceneFloatSection, OverrideRegistry) == 0x000230, "Member 'UMovieSceneFloatSection::OverrideRegistry' has a wrong offset!");
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneIntegerChannel              IntegerCurve;                                      // 0x0100(0x0120)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneIntegerSection) == 0x000220, "Wrong size on UMovieSceneIntegerSection");
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneObjectPathChannel           ObjectChannel;                                     // 0x0100(0x0148)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneParticleSection) == 0x000218, "Wrong size on UMovieSceneParticleSection");
...
static_assert(sizeof(UMovieScenePrimitiveMaterialSection) == 0x000248, "Wrong size on UMovieScenePrimitiveMaterialSection");
...
public:
	...
	uint8                                         Pad_305[0x73];                                     // 0x0305(0x0073)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneSkeletalAnimationSection) == 0x000380, "Wrong size on UMovieSceneSkeletalAnimationSection");
...
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, AnimSequence) == 0x000268, "Member 'UMovieSceneSkeletalAnimationSection::AnimSequence' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, Animation) == 0x000270, "Member 'UMovieSceneSkeletalAnimationSection::Animation' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, StartOffset) == 0x000278, "Member 'UMovieSceneSkeletalAnimationSection::StartOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, EndOffset) == 0x00027C, "Member 'UMovieSceneSkeletalAnimationSection::EndOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, PlayRate) == 0x000280, "Member 'UMovieSceneSkeletalAnimationSection::PlayRate' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, SlotName) == 0x000288, "Member 'UMovieSceneSkeletalAnimationSection::SlotName' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, StartLocationOffset) == 0x000290, "Member 'UMovieSceneSkeletalAnimationSection::StartLocationOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, StartRotationOffset) == 0x0002A8, "Member 'UMovieSceneSkeletalAnimationSection::StartRotationOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchWithPrevious) == 0x0002C0, "Member 'UMovieSceneSkeletalAnimationSection::bMatchWithPrevious' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, MatchedBoneName) == 0x0002C4, "Member 'UMovieSceneSkeletalAnimationSection::MatchedBoneName' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, MatchedLocationOffset) == 0x0002D0, "Member 'UMovieSceneSkeletalAnimationSection::MatchedLocationOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, MatchedRotationOffset) == 0x0002E8, "Member 'UMovieSceneSkeletalAnimationSection::MatchedRotationOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchTranslation) == 0x000300, "Member 'UMovieSceneSkeletalAnimationSection::bMatchTranslation' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchIncludeZHeight) == 0x000301, "Member 'UMovieSceneSkeletalAnimationSection::bMatchIncludeZHeight' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchRotationYaw) == 0x000302, "Member 'UMovieSceneSkeletalAnimationSection::bMatchRotationYaw' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchRotationPitch) == 0x000303, "Member 'UMovieSceneSkeletalAnimationSection::bMatchRotationPitch' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, bMatchRotationRoll) == 0x000304, "Member 'UMovieSceneSkeletalAnimationSection::bMatchRotationRoll' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneSlomoSection) == 0x000228, "Wrong size on UMovieSceneSlomoSection");
...
static_assert(sizeof(UMovieSceneStringSection) == 0x000228, "Wrong size on UMovieSceneStringSection");
...
static_assert(sizeof(UMovieSceneFloatVectorSection) == 0x0005A8, "Wrong size on UMovieSceneFloatVectorSection");
...
static_assert(offsetof(UMovieSceneFloatVectorSection, ChannelsUsed) == 0x0005A0, "Member 'UMovieSceneFloatVectorSection::ChannelsUsed' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneDoubleVectorSection) == 0x0005C8, "Wrong size on UMovieSceneDoubleVectorSection");
...
static_assert(offsetof(UMovieSceneDoubleVectorSection, ChannelsUsed) == 0x0005C0, "Member 'UMovieSceneDoubleVectorSection::ChannelsUsed' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneVisibilitySection) == 0x000228, "Wrong size on UMovieSceneVisibilitySection");
...
static_assert(offsetof(UMovieScene3DTransformTrack, BlenderSystemClass) == 0x0000D8, "Member 'UMovieScene3DTransformTrack::BlenderSystemClass' has a wrong offset!");
...
public:
	...
	bool                                          bAutoArrangeSections;                              // 0x00B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneCameraCutTrack) == 0x0000C0, "Wrong size on UMovieSceneCameraCutTrack");
...
static_assert(offsetof(UMovieSceneCameraCutTrack, bAutoArrangeSections) == 0x0000B8, "Member 'UMovieSceneCameraCutTrack::bAutoArrangeSections' has a wrong offset!");
...
public:
	...
	class UMovieSceneSection*                     SectionToKey;                                      // 0x00C0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneCustomPrimitiveDataTrack) == 0x0000C8, "Wrong size on UMovieSceneCustomPrimitiveDataTrack");
static_assert(offsetof(UMovieSceneCustomPrimitiveDataTrack, Sections) == 0x0000B0, "Member 'UMovieSceneCustomPrimitiveDataTrack::Sections' has a wrong offset!");
static_assert(offsetof(UMovieSceneCustomPrimitiveDataTrack, SectionToKey) == 0x0000C0, "Member 'UMovieSceneCustomPrimitiveDataTrack::SectionToKey' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneDoubleTrack) == 0x0000D0, "Wrong size on UMovieSceneDoubleTrack");
...
static_assert(sizeof(UMovieSceneComponentMaterialTrack) == 0x0000D8, "Wrong size on UMovieSceneComponentMaterialTrack");
static_assert(offsetof(UMovieSceneComponentMaterialTrack, MaterialInfo) == 0x0000C8, "Member 'UMovieSceneComponentMaterialTrack::MaterialInfo' has a wrong offset!");
...
{
public:
	struct FComponentMaterialInfo                 MaterialInfo;                                      // 0x00D0(0x0010)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieScenePrimitiveMaterialTrack, MaterialInfo) == 0x0000D0, "Member 'UMovieScenePrimitiveMaterialTrack::MaterialInfo' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneFloatVectorTrack) == 0x0000D8, "Wrong size on UMovieSceneFloatVectorTrack");
static_assert(offsetof(UMovieSceneFloatVectorTrack, NumChannelsUsed) == 0x0000D0, "Member 'UMovieSceneFloatVectorTrack::NumChannelsUsed' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneDoubleVectorTrack) == 0x0000D8, "Wrong size on UMovieSceneDoubleVectorTrack");
static_assert(offsetof(UMovieSceneDoubleVectorTrack, NumChannelsUsed) == 0x0000D0, "Member 'UMovieSceneDoubleVectorTrack::NumChannelsUsed' has a wrong offset!");
