...
static_assert(sizeof(FToolMenuProfile) == 0x0001A8, "Wrong size on FToolMenuProfile");
...
static_assert(offsetof(FCustomizedToolMenu, EntryOrder) == 0x0001A8, "Member 'FCustomizedToolMenu::EntryOrder' has a wrong offset!");
static_assert(offsetof(FCustomizedToolMenu, SectionOrder) == 0x0001F8, "Member 'FCustomizedToolMenu::SectionOrder' has a wrong offset!");
