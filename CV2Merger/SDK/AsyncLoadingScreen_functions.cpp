...
void UAsyncLoadingScreenSubsystem::HideScreen(class UObject* Request)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AsyncLoadingScreenSubsystem", "HideScreen");

	Params::AsyncLoadingScreenSubsystem_HideScreen Parms{};
...
void UAsyncLoadingScreenSubsystem::ShowScreen(class UObject* Request)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AsyncLoadingScreenSubsystem", "ShowScreen");

	Params::AsyncLoadingScreenSubsystem_ShowScreen Parms{};
