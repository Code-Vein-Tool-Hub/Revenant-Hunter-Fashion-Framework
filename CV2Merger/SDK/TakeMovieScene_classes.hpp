...
static_assert(sizeof(UMovieSceneTakeSection) == 0x0007C8, "Wrong size on UMovieSceneTakeSection");
...
static_assert(offsetof(UMovieSceneTakeSection, MinutesCurve) == 0x000218, "Member 'UMovieSceneTakeSection::MinutesCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneTakeSection, SecondsCurve) == 0x000338, "Member 'UMovieSceneTakeSection::SecondsCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneTakeSection, FramesCurve) == 0x000458, "Member 'UMovieSceneTakeSection::FramesCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneTakeSection, SubFramesCurve) == 0x000578, "Member 'UMovieSceneTakeSection::SubFramesCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneTakeSection, Slate) == 0x0006A0, "Member 'UMovieSceneTakeSection::Slate' has a wrong offset!");
