...
static_assert(alignof(AutoPlayAgent_AddElement) == 0x000008, "Wrong alignment on AutoPlayAgent_AddElement");
static_assert(sizeof(AutoPlayAgent_AddElement) == 0x000010, "Wrong size on AutoPlayAgent_AddElement");
static_assert(offsetof(AutoPlayAgent_AddElement, ElementClass) == 0x000000, "Member 'AutoPlayAgent_AddElement::ElementClass' has a wrong offset!");
static_assert(offsetof(AutoPlayAgent_AddElement, ReturnValue) == 0x000008, "Member 'AutoPlayAgent_AddElement::ReturnValue' has a wrong offset!");
...
static_assert(alignof(AutoPlayAgent_FindElementByClass) == 0x000008, "Wrong alignment on AutoPlayAgent_FindElementByClass");
static_assert(sizeof(AutoPlayAgent_FindElementByClass) == 0x000010, "Wrong size on AutoPlayAgent_FindElementByClass");
static_assert(offsetof(AutoPlayAgent_FindElementByClass, ElementClass) == 0x000000, "Member 'AutoPlayAgent_FindElementByClass::ElementClass' has a wrong offset!");
static_assert(offsetof(AutoPlayAgent_FindElementByClass, ReturnValue) == 0x000008, "Member 'AutoPlayAgent_FindElementByClass::ReturnValue' has a wrong offset!");
...
static_assert(alignof(AutoPlayAgent_GetLocalPlayer) == 0x000008, "Wrong alignment on AutoPlayAgent_GetLocalPlayer");
static_assert(sizeof(AutoPlayAgent_GetLocalPlayer) == 0x000008, "Wrong size on AutoPlayAgent_GetLocalPlayer");
static_assert(offsetof(AutoPlayAgent_GetLocalPlayer, ReturnValue) == 0x000000, "Member 'AutoPlayAgent_GetLocalPlayer::ReturnValue' has a wrong offset!");
...
static_assert(alignof(AutoPlayInput_CancelInput) == 0x000004, "Wrong alignment on AutoPlayInput_CancelInput");
static_assert(sizeof(AutoPlayInput_CancelInput) == 0x000004, "Wrong size on AutoPlayInput_CancelInput");
static_assert(offsetof(AutoPlayInput_CancelInput, Handle) == 0x000000, "Member 'AutoPlayInput_CancelInput::Handle' has a wrong offset!");
...
static_assert(sizeof(AutoPlayInput_InputKey) == 0x000028, "Wrong size on AutoPlayInput_InputKey");
...
static_assert(offsetof(AutoPlayInput_InputKey, ReturnValue) == 0x000020, "Member 'AutoPlayInput_InputKey::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AutoPlaySubsystem_RecordMacro, Name_0) == 0x000000, "Member 'AutoPlaySubsystem_RecordMacro::Name_0' has a wrong offset!");
...
static_assert(sizeof(AutoPlaySubsystem_RunMacro) == 0x000018, "Wrong size on AutoPlaySubsystem_RunMacro");
static_assert(offsetof(AutoPlaySubsystem_RunMacro, Name_0) == 0x000000, "Member 'AutoPlaySubsystem_RunMacro::Name_0' has a wrong offset!");
static_assert(offsetof(AutoPlaySubsystem_RunMacro, DetailLevel) == 0x000010, "Member 'AutoPlaySubsystem_RunMacro::DetailLevel' has a wrong offset!");
...
static_assert(offsetof(AutoPlayMacroSystem_GetValueAsFloat, Name_0) == 0x000050, "Member 'AutoPlayMacroSystem_GetValueAsFloat::Name_0' has a wrong offset!");
...
static_assert(offsetof(AutoPlayMacroSystem_GetValueAsObject, Name_0) == 0x000050, "Member 'AutoPlayMacroSystem_GetValueAsObject::Name_0' has a wrong offset!");
...
static_assert(alignof(AutoPlayService_BlueprintBase_ReceiveTick) == 0x000004, "Wrong alignment on AutoPlayService_BlueprintBase_ReceiveTick");
static_assert(sizeof(AutoPlayService_BlueprintBase_ReceiveTick) == 0x000004, "Wrong size on AutoPlayService_BlueprintBase_ReceiveTick");
static_assert(offsetof(AutoPlayService_BlueprintBase_ReceiveTick, DeltaTime) == 0x000000, "Member 'AutoPlayService_BlueprintBase_ReceiveTick::DeltaTime' has a wrong offset!");
...
static_assert(alignof(AutoPlayTask_AddService) == 0x000008, "Wrong alignment on AutoPlayTask_AddService");
static_assert(sizeof(AutoPlayTask_AddService) == 0x000010, "Wrong size on AutoPlayTask_AddService");
static_assert(offsetof(AutoPlayTask_AddService, ServiceClass) == 0x000000, "Member 'AutoPlayTask_AddService::ServiceClass' has a wrong offset!");
static_assert(offsetof(AutoPlayTask_AddService, ReturnValue) == 0x000008, "Member 'AutoPlayTask_AddService::ReturnValue' has a wrong offset!");
...
static_assert(alignof(AutoPlayTask_MoveCursor_SetGoalPosition) == 0x000008, "Wrong alignment on AutoPlayTask_MoveCursor_SetGoalPosition");
static_assert(sizeof(AutoPlayTask_MoveCursor_SetGoalPosition) == 0x000010, "Wrong size on AutoPlayTask_MoveCursor_SetGoalPosition");
static_assert(offsetof(AutoPlayTask_MoveCursor_SetGoalPosition, Position) == 0x000000, "Member 'AutoPlayTask_MoveCursor_SetGoalPosition::Position' has a wrong offset!");
...
static_assert(alignof(AutoPlayTask_MoveCursor_SetImmediately) == 0x000001, "Wrong alignment on AutoPlayTask_MoveCursor_SetImmediately");
static_assert(sizeof(AutoPlayTask_MoveCursor_SetImmediately) == 0x000001, "Wrong size on AutoPlayTask_MoveCursor_SetImmediately");
static_assert(offsetof(AutoPlayTask_MoveCursor_SetImmediately, bInImmediately) == 0x000000, "Member 'AutoPlayTask_MoveCursor_SetImmediately::bInImmediately' has a wrong offset!");
...
static_assert(alignof(AutoPlayTask_MoveCursor_SetSpeed) == 0x000004, "Wrong alignment on AutoPlayTask_MoveCursor_SetSpeed");
static_assert(sizeof(AutoPlayTask_MoveCursor_SetSpeed) == 0x000004, "Wrong size on AutoPlayTask_MoveCursor_SetSpeed");
static_assert(offsetof(AutoPlayTask_MoveCursor_SetSpeed, InSpeed) == 0x000000, "Member 'AutoPlayTask_MoveCursor_SetSpeed::InSpeed' has a wrong offset!");
