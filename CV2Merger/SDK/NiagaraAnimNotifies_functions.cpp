...
class UFXSystemComponent* UAnimNotifyState_TrailNiagaraEffect::GetSpawnedEffect(class UMeshComponent* MeshComp) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AnimNotifyState_TrailNiagaraEffect", "GetSpawnedEffect");

	Params::AnimNotifyState_TrailNiagaraEffect_GetSpawnedEffect Parms{};
