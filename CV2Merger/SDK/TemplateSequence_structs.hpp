...
public:
	...
	struct FMovieSceneFloatChannel                FloatChannel;                                      // 0x0028(0x0128)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FTemplateSectionPropertyScale) == 0x000008, "Wrong alignment on FTemplateSectionPropertyScale");
static_assert(sizeof(FTemplateSectionPropertyScale) == 0x000150, "Wrong size on FTemplateSectionPropertyScale");
