...
public:
	...
	uint8                                         Pad_848[0x68];                                     // 0x0848(0x0068)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UTypedElementSelectionSet) == 0x0008B0, "Wrong size on UTypedElementSelectionSet");
