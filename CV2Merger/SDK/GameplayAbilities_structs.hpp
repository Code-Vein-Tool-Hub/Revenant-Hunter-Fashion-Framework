...
static_assert(offsetof(FActiveGameplayEffect, GrantedAbilityHandles) == 0x0002C0, "Member 'FActiveGameplayEffect::GrantedAbilityHandles' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffect, StartServerWorldTime) == 0x0002D0, "Member 'FActiveGameplayEffect::StartServerWorldTime' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffect, CachedStartServerWorldTime) == 0x0002D4, "Member 'FActiveGameplayEffect::CachedStartServerWorldTime' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffect, StartWorldTime) == 0x0002D8, "Member 'FActiveGameplayEffect::StartWorldTime' has a wrong offset!");
static_assert(offsetof(FActiveGameplayEffect, bIsInhibited) == 0x0002DC, "Member 'FActiveGameplayEffect::bIsInhibited' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneGameplayCueChannel) == 0x000110, "Wrong size on FMovieSceneGameplayCueChannel");
static_assert(offsetof(FMovieSceneGameplayCueChannel, KeyTimes) == 0x000068, "Member 'FMovieSceneGameplayCueChannel::KeyTimes' has a wrong offset!");
static_assert(offsetof(FMovieSceneGameplayCueChannel, KeyValues) == 0x000078, "Member 'FMovieSceneGameplayCueChannel::KeyValues' has a wrong offset!");
