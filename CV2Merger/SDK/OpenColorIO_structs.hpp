...
static_assert(sizeof(FOpenColorIOColorConversionSettings) == 0x0000A0, "Wrong size on FOpenColorIOColorConversionSettings");
...
static_assert(sizeof(FOpenColorIODisplayConfiguration) == 0x0000A8, "Wrong size on FOpenColorIODisplayConfiguration");
