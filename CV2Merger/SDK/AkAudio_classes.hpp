...
public:
	...
	uint8                                         Pad_239[0xD7];                                     // 0x0239(0x00D7)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAkPortalComponent) == 0x000310, "Wrong size on UAkPortalComponent");
...
static_assert(offsetof(UAkPortalComponent, ObstructionRefreshInterval) == 0x000234, "Member 'UAkPortalComponent::ObstructionRefreshInterval' has a wrong offset!");
static_assert(offsetof(UAkPortalComponent, ObstructionCollisionChannel) == 0x000238, "Member 'UAkPortalComponent::ObstructionCollisionChannel' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_250[0x2];                                      // 0x0250(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAkGameObject) == 0x000260, "Wrong size on UAkGameObject");
...
static_assert(offsetof(UAkGameObject, EventName) == 0x000240, "Member 'UAkGameObject::EventName' has a wrong offset!");
static_assert(offsetof(UAkGameObject, bAttenuationScalingMigrated) == 0x000252, "Member 'UAkGameObject::bAttenuationScalingMigrated' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2B1[0x15F];                                    // 0x02B1(0x015F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UAkComponent, bUseSpatialAudio) == 0x000258, "Member 'UAkComponent::bUseSpatialAudio' has a wrong offset!");
static_assert(offsetof(UAkComponent, OcclusionCollisionChannel) == 0x000260, "Member 'UAkComponent::OcclusionCollisionChannel' has a wrong offset!");
static_assert(offsetof(UAkComponent, EnableSpotReflectors) == 0x000261, "Member 'UAkComponent::EnableSpotReflectors' has a wrong offset!");
static_assert(offsetof(UAkComponent, OuterRadius) == 0x000264, "Member 'UAkComponent::OuterRadius' has a wrong offset!");
static_assert(offsetof(UAkComponent, InnerRadius) == 0x000268, "Member 'UAkComponent::InnerRadius' has a wrong offset!");
static_assert(offsetof(UAkComponent, EarlyReflectionAuxBus) == 0x000270, "Member 'UAkComponent::EarlyReflectionAuxBus' has a wrong offset!");
static_assert(offsetof(UAkComponent, EarlyReflectionAuxBusName) == 0x000278, "Member 'UAkComponent::EarlyReflectionAuxBusName' has a wrong offset!");
static_assert(offsetof(UAkComponent, EarlyReflectionOrder) == 0x000288, "Member 'UAkComponent::EarlyReflectionOrder' has a wrong offset!");
static_assert(offsetof(UAkComponent, EarlyReflectionBusSendGain) == 0x00028C, "Member 'UAkComponent::EarlyReflectionBusSendGain' has a wrong offset!");
static_assert(offsetof(UAkComponent, EarlyReflectionMaxPathLength) == 0x000290, "Member 'UAkComponent::EarlyReflectionMaxPathLength' has a wrong offset!");
static_assert(offsetof(UAkComponent, RoomReverbAuxBusGain) == 0x000294, "Member 'UAkComponent::RoomReverbAuxBusGain' has a wrong offset!");
static_assert(offsetof(UAkComponent, DiffractionMaxEdges) == 0x000298, "Member 'UAkComponent::DiffractionMaxEdges' has a wrong offset!");
static_assert(offsetof(UAkComponent, DiffractionMaxPaths) == 0x00029C, "Member 'UAkComponent::DiffractionMaxPaths' has a wrong offset!");
static_assert(offsetof(UAkComponent, DiffractionMaxPathLength) == 0x0002A0, "Member 'UAkComponent::DiffractionMaxPathLength' has a wrong offset!");
...
static_assert(offsetof(UAkComponent, OcclusionRefreshInterval) == 0x0002AC, "Member 'UAkComponent::OcclusionRefreshInterval' has a wrong offset!");
static_assert(offsetof(UAkComponent, bUseReverbVolumes) == 0x0002B0, "Member 'UAkComponent::bUseReverbVolumes' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_F98[0x58];                                     // 0x0F98(0x0058)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAkRoomComponent) == 0x000290, "Wrong size on UAkRoomComponent");
static_assert(offsetof(UAkRoomComponent, bEnable) == 0x000258, "Member 'UAkRoomComponent::bEnable' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, bDynamic) == 0x000259, "Member 'UAkRoomComponent::bDynamic' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, Priority) == 0x00025C, "Member 'UAkRoomComponent::Priority' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, WallOcclusion) == 0x000260, "Member 'UAkRoomComponent::WallOcclusion' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, AuxSendLevel) == 0x000264, "Member 'UAkRoomComponent::AuxSendLevel' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, AutoPost) == 0x000268, "Member 'UAkRoomComponent::AutoPost' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, GeometryComponent) == 0x000278, "Member 'UAkRoomComponent::GeometryComponent' has a wrong offset!");
...
public:
	...
	float                                         DefaultListenerScalingFactor;                      // 0x0320(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FSoftClassPath                         AkComponentClassName;                              // 0x0328(0x0020)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FDirectoryPath                         WwiseWindowsInstallationPath;                      // 0x0350(0x0010)(ZeroConstructor, Config, Deprecated, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFilePath                              WwiseMacInstallationPath;                          // 0x0360(0x0010)(ZeroConstructor, Config, Deprecated, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAkSettings, DefaultListenerScalingFactor) == 0x000320, "Member 'UAkSettings::DefaultListenerScalingFactor' has a wrong offset!");
...
static_assert(offsetof(UAkSettings, AkComponentClassName) == 0x000328, "Member 'UAkSettings::AkComponentClassName' has a wrong offset!");
...
public:
	...
	bool                                          bDisplayBillboard;                                 // 0x0086(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          AskForWwiseAssetReload;                            // 0x0087(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAkSettingsPerUser, bDisplayBillboard) == 0x000086, "Member 'UAkSettingsPerUser::bDisplayBillboard' has a wrong offset!");
static_assert(offsetof(UAkSettingsPerUser, AskForWwiseAssetReload) == 0x000087, "Member 'UAkSettingsPerUser::AskForWwiseAssetReload' has a wrong offset!");
...
static_assert(sizeof(UAkSubmixInputComponent) == 0x000460, "Wrong size on UAkSubmixInputComponent");
static_assert(offsetof(UAkSubmixInputComponent, SubmixToRecord) == 0x000438, "Member 'UAkSubmixInputComponent::SubmixToRecord' has a wrong offset!");
...
static_assert(sizeof(UAkXboxSeriesXInitializationSettings) == 0x000108, "Wrong size on UAkXboxSeriesXInitializationSettings");
...
static_assert(offsetof(UAkXboxSeriesXInitializationSettings, ApuHeapSettings) == 0x000098, "Member 'UAkXboxSeriesXInitializationSettings::ApuHeapSettings' has a wrong offset!");
static_assert(offsetof(UAkXboxSeriesXInitializationSettings, CommunicationSettings) == 0x0000A0, "Member 'UAkXboxSeriesXInitializationSettings::CommunicationSettings' has a wrong offset!");
static_assert(offsetof(UAkXboxSeriesXInitializationSettings, AdvancedSettings) == 0x0000C0, "Member 'UAkXboxSeriesXInitializationSettings::AdvancedSettings' has a wrong offset!");
...
public:
	...
	struct FMovieSceneFloatChannel                RTPCChannel;                                       // 0x01C0(0x0128)(Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneAkAudioRTPCSection) == 0x0002E8, "Wrong size on UMovieSceneAkAudioRTPCSection");
