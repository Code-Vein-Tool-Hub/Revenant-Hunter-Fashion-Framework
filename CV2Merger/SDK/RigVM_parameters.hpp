...
{
public:
	struct FRigVMExtendedExecuteContext           Context;                                           // 0x0000(0x0230)(Parm, OutParm, NativeAccessSpecifierPublic)
	class FName                                   InEntryName;                                       // 0x0230(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(RigVM_Execute) == 0x000240, "Wrong size on RigVM_Execute");
static_assert(offsetof(RigVM_Execute, Context) == 0x000000, "Member 'RigVM_Execute::Context' has a wrong offset!");
static_assert(offsetof(RigVM_Execute, InEntryName) == 0x000230, "Member 'RigVM_Execute::InEntryName' has a wrong offset!");
static_assert(offsetof(RigVM_Execute, ReturnValue) == 0x000238, "Member 'RigVM_Execute::ReturnValue' has a wrong offset!");
...
{
public:
	struct FRigVMExtendedExecuteContext           ReturnValue;                                       // 0x0000(0x0230)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(RigVMHost_GetExtendedExecuteContext) == 0x000230, "Wrong size on RigVMHost_GetExtendedExecuteContext");
