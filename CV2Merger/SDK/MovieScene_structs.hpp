...
static_assert(sizeof(FMovieSceneChannel) == 0x000068, "Wrong size on FMovieSceneChannel");
...
static_assert(sizeof(FMovieSceneAudioTriggerChannel) == 0x000110, "Wrong size on FMovieSceneAudioTriggerChannel");
static_assert(offsetof(FMovieSceneAudioTriggerChannel, Times) == 0x000068, "Member 'FMovieSceneAudioTriggerChannel::Times' has a wrong offset!");
static_assert(offsetof(FMovieSceneAudioTriggerChannel, Values) == 0x000078, "Member 'FMovieSceneAudioTriggerChannel::Values' has a wrong offset!");
static_assert(offsetof(FMovieSceneAudioTriggerChannel, KeyHandles) == 0x000088, "Member 'FMovieSceneAudioTriggerChannel::KeyHandles' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneBoolChannel) == 0x000120, "Wrong size on FMovieSceneBoolChannel");
static_assert(offsetof(FMovieSceneBoolChannel, PreInfinityExtrap) == 0x000068, "Member 'FMovieSceneBoolChannel::PreInfinityExtrap' has a wrong offset!");
static_assert(offsetof(FMovieSceneBoolChannel, PostInfinityExtrap) == 0x000069, "Member 'FMovieSceneBoolChannel::PostInfinityExtrap' has a wrong offset!");
static_assert(offsetof(FMovieSceneBoolChannel, Times) == 0x000070, "Member 'FMovieSceneBoolChannel::Times' has a wrong offset!");
static_assert(offsetof(FMovieSceneBoolChannel, DefaultValue) == 0x000080, "Member 'FMovieSceneBoolChannel::DefaultValue' has a wrong offset!");
static_assert(offsetof(FMovieSceneBoolChannel, bHasDefaultValue) == 0x000081, "Member 'FMovieSceneBoolChannel::bHasDefaultValue' has a wrong offset!");
static_assert(offsetof(FMovieSceneBoolChannel, Values) == 0x000088, "Member 'FMovieSceneBoolChannel::Values' has a wrong offset!");
static_assert(offsetof(FMovieSceneBoolChannel, KeyHandles) == 0x000098, "Member 'FMovieSceneBoolChannel::KeyHandles' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneByteChannel) == 0x000120, "Wrong size on FMovieSceneByteChannel");
static_assert(offsetof(FMovieSceneByteChannel, Times) == 0x000068, "Member 'FMovieSceneByteChannel::Times' has a wrong offset!");
static_assert(offsetof(FMovieSceneByteChannel, DefaultValue) == 0x000078, "Member 'FMovieSceneByteChannel::DefaultValue' has a wrong offset!");
static_assert(offsetof(FMovieSceneByteChannel, bHasDefaultValue) == 0x000079, "Member 'FMovieSceneByteChannel::bHasDefaultValue' has a wrong offset!");
static_assert(offsetof(FMovieSceneByteChannel, Values) == 0x000080, "Member 'FMovieSceneByteChannel::Values' has a wrong offset!");
static_assert(offsetof(FMovieSceneByteChannel, Enum) == 0x000090, "Member 'FMovieSceneByteChannel::Enum' has a wrong offset!");
static_assert(offsetof(FMovieSceneByteChannel, KeyHandles) == 0x000098, "Member 'FMovieSceneByteChannel::KeyHandles' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneDoubleChannel) == 0x000130, "Wrong size on FMovieSceneDoubleChannel");
static_assert(offsetof(FMovieSceneDoubleChannel, PreInfinityExtrap) == 0x000068, "Member 'FMovieSceneDoubleChannel::PreInfinityExtrap' has a wrong offset!");
static_assert(offsetof(FMovieSceneDoubleChannel, PostInfinityExtrap) == 0x000069, "Member 'FMovieSceneDoubleChannel::PostInfinityExtrap' has a wrong offset!");
static_assert(offsetof(FMovieSceneDoubleChannel, Times) == 0x000070, "Member 'FMovieSceneDoubleChannel::Times' has a wrong offset!");
static_assert(offsetof(FMovieSceneDoubleChannel, Values) == 0x000080, "Member 'FMovieSceneDoubleChannel::Values' has a wrong offset!");
static_assert(offsetof(FMovieSceneDoubleChannel, DefaultValue) == 0x000090, "Member 'FMovieSceneDoubleChannel::DefaultValue' has a wrong offset!");
static_assert(offsetof(FMovieSceneDoubleChannel, bHasDefaultValue) == 0x000098, "Member 'FMovieSceneDoubleChannel::bHasDefaultValue' has a wrong offset!");
static_assert(offsetof(FMovieSceneDoubleChannel, KeyHandles) == 0x0000A0, "Member 'FMovieSceneDoubleChannel::KeyHandles' has a wrong offset!");
static_assert(offsetof(FMovieSceneDoubleChannel, TickResolution) == 0x000128, "Member 'FMovieSceneDoubleChannel::TickResolution' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneFloatChannel) == 0x000128, "Wrong size on FMovieSceneFloatChannel");
static_assert(offsetof(FMovieSceneFloatChannel, PreInfinityExtrap) == 0x000068, "Member 'FMovieSceneFloatChannel::PreInfinityExtrap' has a wrong offset!");
static_assert(offsetof(FMovieSceneFloatChannel, PostInfinityExtrap) == 0x000069, "Member 'FMovieSceneFloatChannel::PostInfinityExtrap' has a wrong offset!");
static_assert(offsetof(FMovieSceneFloatChannel, Times) == 0x000070, "Member 'FMovieSceneFloatChannel::Times' has a wrong offset!");
static_assert(offsetof(FMovieSceneFloatChannel, Values) == 0x000080, "Member 'FMovieSceneFloatChannel::Values' has a wrong offset!");
static_assert(offsetof(FMovieSceneFloatChannel, DefaultValue) == 0x000090, "Member 'FMovieSceneFloatChannel::DefaultValue' has a wrong offset!");
static_assert(offsetof(FMovieSceneFloatChannel, bHasDefaultValue) == 0x000094, "Member 'FMovieSceneFloatChannel::bHasDefaultValue' has a wrong offset!");
static_assert(offsetof(FMovieSceneFloatChannel, KeyHandles) == 0x000098, "Member 'FMovieSceneFloatChannel::KeyHandles' has a wrong offset!");
static_assert(offsetof(FMovieSceneFloatChannel, TickResolution) == 0x000120, "Member 'FMovieSceneFloatChannel::TickResolution' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneIntegerChannel) == 0x000120, "Wrong size on FMovieSceneIntegerChannel");
static_assert(offsetof(FMovieSceneIntegerChannel, PreInfinityExtrap) == 0x000068, "Member 'FMovieSceneIntegerChannel::PreInfinityExtrap' has a wrong offset!");
static_assert(offsetof(FMovieSceneIntegerChannel, PostInfinityExtrap) == 0x000069, "Member 'FMovieSceneIntegerChannel::PostInfinityExtrap' has a wrong offset!");
static_assert(offsetof(FMovieSceneIntegerChannel, Times) == 0x000070, "Member 'FMovieSceneIntegerChannel::Times' has a wrong offset!");
static_assert(offsetof(FMovieSceneIntegerChannel, DefaultValue) == 0x000080, "Member 'FMovieSceneIntegerChannel::DefaultValue' has a wrong offset!");
static_assert(offsetof(FMovieSceneIntegerChannel, bHasDefaultValue) == 0x000084, "Member 'FMovieSceneIntegerChannel::bHasDefaultValue' has a wrong offset!");
static_assert(offsetof(FMovieSceneIntegerChannel, Values) == 0x000088, "Member 'FMovieSceneIntegerChannel::Values' has a wrong offset!");
static_assert(offsetof(FMovieSceneIntegerChannel, KeyHandles) == 0x000098, "Member 'FMovieSceneIntegerChannel::KeyHandles' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneObjectPathChannel) == 0x000148, "Wrong size on FMovieSceneObjectPathChannel");
static_assert(offsetof(FMovieSceneObjectPathChannel, PropertyClass) == 0x000068, "Member 'FMovieSceneObjectPathChannel::PropertyClass' has a wrong offset!");
static_assert(offsetof(FMovieSceneObjectPathChannel, Times) == 0x000070, "Member 'FMovieSceneObjectPathChannel::Times' has a wrong offset!");
static_assert(offsetof(FMovieSceneObjectPathChannel, Values) == 0x000080, "Member 'FMovieSceneObjectPathChannel::Values' has a wrong offset!");
static_assert(offsetof(FMovieSceneObjectPathChannel, DefaultValue) == 0x000090, "Member 'FMovieSceneObjectPathChannel::DefaultValue' has a wrong offset!");
static_assert(offsetof(FMovieSceneObjectPathChannel, KeyHandles) == 0x0000C0, "Member 'FMovieSceneObjectPathChannel::KeyHandles' has a wrong offset!");
