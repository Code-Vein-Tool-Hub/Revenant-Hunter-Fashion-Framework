...
static_assert(sizeof(UTransformableHandle) == 0x000068, "Wrong size on UTransformableHandle");
...
static_assert(offsetof(UTransformableComponentHandle, Component) == 0x000068, "Member 'UTransformableComponentHandle::Component' has a wrong offset!");
static_assert(offsetof(UTransformableComponentHandle, SocketName) == 0x000070, "Member 'UTransformableComponentHandle::SocketName' has a wrong offset!");
