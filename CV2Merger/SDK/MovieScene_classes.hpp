...
public:
	...
	uint8                                         Pad_430[0x350];                                    // 0x0430(0x0350)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneEntitySystemLinker) == 0x000780, "Wrong size on UMovieSceneEntitySystemLinker");
...
static_assert(sizeof(UMovieScene) == 0x000168, "Wrong size on UMovieScene");
...
static_assert(offsetof(UMovieScene, MarkedFrames) == 0x000158, "Member 'UMovieScene::MarkedFrames' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnPlay;                                            // 0x0228(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPlayReverse;                                     // 0x0238(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnStop;                                            // 0x0248(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPause;                                           // 0x0258(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFinished;                                        // 0x0268(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	void PlayWithFrameRate(const struct FFrameRate& FrameRate);
	void RemoveWeight();
	void RestoreState();
...
public:
	...
	struct FMovieSceneBoolChannel                 BoolCurve;                                         // 0x0100(0x0120)(Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneBoolSection) == 0x000220, "Wrong size on UMovieSceneBoolSection");
...
static_assert(sizeof(UMovieSceneSpawnSection) == 0x000228, "Wrong size on UMovieSceneSpawnSection");
...
static_assert(sizeof(UMovieSceneSubSection) == 0x000140, "Wrong size on UMovieSceneSubSection");
...
static_assert(offsetof(UMovieSceneSubSection, StartOffset) == 0x000128, "Member 'UMovieSceneSubSection::StartOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, TimeScale) == 0x00012C, "Member 'UMovieSceneSubSection::TimeScale' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, PrerollTime_MovieSceneSubSection) == 0x000130, "Member 'UMovieSceneSubSection::PrerollTime_MovieSceneSubSection' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, NetworkMask) == 0x000134, "Member 'UMovieSceneSubSection::NetworkMask' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, SubSequence) == 0x000138, "Member 'UMovieSceneSubSection::SubSequence' has a wrong offset!");
...
static_assert(sizeof(UTestMovieSceneSubSection) == 0x000140, "Wrong size on UTestMovieSceneSubSection");
...
static_assert(sizeof(UMovieSceneBindingLifetimeTrack) == 0x0000B8, "Wrong size on UMovieSceneBindingLifetimeTrack");
static_assert(offsetof(UMovieSceneBindingLifetimeTrack, Sections) == 0x0000A8, "Member 'UMovieSceneBindingLifetimeTrack::Sections' has a wrong offset!");
