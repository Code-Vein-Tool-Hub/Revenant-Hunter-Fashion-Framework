...
public:
	...
	bool                                          bIsDamage;                                         // 0x0074(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_75[0x3];                                       // 0x0075(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   DamageParameterName;                               // 0x0078(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowExperimentalProperties;                       // 0x0080(0x0001)(Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPhysicalMaterialSoftCollisionMode            SoftCollisionMode;                                 // 0x0081(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_82[0x2];                                       // 0x0082(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SoftCollisionThickness;                            // 0x0084(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         BaseFrictionImpulse;                               // 0x0088(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPhysicalMaterial) == 0x0000A8, "Wrong size on UPhysicalMaterial");
...
static_assert(offsetof(UPhysicalMaterial, bIsDamage) == 0x000074, "Member 'UPhysicalMaterial::bIsDamage' has a wrong offset!");
static_assert(offsetof(UPhysicalMaterial, DamageParameterName) == 0x000078, "Member 'UPhysicalMaterial::DamageParameterName' has a wrong offset!");
static_assert(offsetof(UPhysicalMaterial, bShowExperimentalProperties) == 0x000080, "Member 'UPhysicalMaterial::bShowExperimentalProperties' has a wrong offset!");
static_assert(offsetof(UPhysicalMaterial, SoftCollisionMode) == 0x000081, "Member 'UPhysicalMaterial::SoftCollisionMode' has a wrong offset!");
static_assert(offsetof(UPhysicalMaterial, SoftCollisionThickness) == 0x000084, "Member 'UPhysicalMaterial::SoftCollisionThickness' has a wrong offset!");
static_assert(offsetof(UPhysicalMaterial, BaseFrictionImpulse) == 0x000088, "Member 'UPhysicalMaterial::BaseFrictionImpulse' has a wrong offset!");
