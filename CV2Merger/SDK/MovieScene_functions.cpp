...
void UMovieSceneSequencePlayer::PlayWithFrameRate(const struct FFrameRate& FrameRate)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MovieSceneSequencePlayer", "PlayWithFrameRate");

	Params::MovieSceneSequencePlayer_PlayWithFrameRate Parms{};
