...
namespace Offsets
{
	...
	constexpr int32 AppendString      = 0x0158F260;
	constexpr int32 GetNameEntry      = 0x015900F0;
	constexpr int32 GNames            = 0x09EFFAC0;
	constexpr int32 GWorld            = 0x09EAD108;
	constexpr int32 ProcessEvent      = 0x017B1370;
