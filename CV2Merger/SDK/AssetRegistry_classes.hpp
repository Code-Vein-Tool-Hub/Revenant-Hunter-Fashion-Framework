...
// 0x0EC0 (0x0EE8 - 0x0028)
class UAssetRegistryImpl final : public UObject
{
public:
	uint8                                         Pad_28[0xEC0];                                     // 0x0028(0x0EC0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAssetRegistryImpl) == 0x000EE8, "Wrong size on UAssetRegistryImpl");
