...
{
public:
	uint8                                         bOverride_ShowFlags : 1;                           // 0x00A0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_A1[0x7];                                       // 0x00A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UMovieGraphShowFlags*                   ShowFlags;                                         // 0x00A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, EditConst, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieGraphImagePassBaseNode) == 0x0000C0, "Wrong size on UMovieGraphImagePassBaseNode");
static_assert(offsetof(UMovieGraphImagePassBaseNode, ShowFlags) == 0x0000A8, "Member 'UMovieGraphImagePassBaseNode::ShowFlags' has a wrong offset!");
...
{
public:
	uint8                                         bOverride_SpatialSampleCount : 1;                  // 0x00C0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_AntiAliasingMethod : 1;                  // 0x00C0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bDisableToneCurve : 1;                   // 0x00C0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bAllowOCIO : 1;                          // 0x00C0(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_ViewModeIndex : 1;                       // 0x00C0(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bWriteAllSamples : 1;                    // 0x00C0(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_AdditionalPostProcessMaterials : 1;      // 0x00C0(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_C1[0x3];                                       // 0x00C1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         SpatialSampleCount;                                // 0x00C4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAntiAliasingMethod                           AntiAliasingMethod;                                // 0x00C8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bWriteAllSamples;                                  // 0x00C9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDisableToneCurve;                                 // 0x00CA(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowOCIO;                                        // 0x00CB(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EViewModeIndex                                ViewModeIndex;                                     // 0x00CC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieGraphDeferredRenderPassNode) == 0x0000E0, "Wrong size on UMovieGraphDeferredRenderPassNode");
static_assert(offsetof(UMovieGraphDeferredRenderPassNode, SpatialSampleCount) == 0x0000C4, "Member 'UMovieGraphDeferredRenderPassNode::SpatialSampleCount' has a wrong offset!");
static_assert(offsetof(UMovieGraphDeferredRenderPassNode, AntiAliasingMethod) == 0x0000C8, "Member 'UMovieGraphDeferredRenderPassNode::AntiAliasingMethod' has a wrong offset!");
static_assert(offsetof(UMovieGraphDeferredRenderPassNode, bWriteAllSamples) == 0x0000C9, "Member 'UMovieGraphDeferredRenderPassNode::bWriteAllSamples' has a wrong offset!");
static_assert(offsetof(UMovieGraphDeferredRenderPassNode, bDisableToneCurve) == 0x0000CA, "Member 'UMovieGraphDeferredRenderPassNode::bDisableToneCurve' has a wrong offset!");
static_assert(offsetof(UMovieGraphDeferredRenderPassNode, bAllowOCIO) == 0x0000CB, "Member 'UMovieGraphDeferredRenderPassNode::bAllowOCIO' has a wrong offset!");
static_assert(offsetof(UMovieGraphDeferredRenderPassNode, ViewModeIndex) == 0x0000CC, "Member 'UMovieGraphDeferredRenderPassNode::ViewModeIndex' has a wrong offset!");
static_assert(offsetof(UMovieGraphDeferredRenderPassNode, AdditionalPostProcessMaterials) == 0x0000D0, "Member 'UMovieGraphDeferredRenderPassNode::AdditionalPostProcessMaterials' has a wrong offset!");
...
{
public:
	uint8                                         bOverride_OCIOConfiguration : 1;                   // 0x00B8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_OCIOContext : 1;                         // 0x00B8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_B9[0x7];                                       // 0x00B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FOpenColorIODisplayConfiguration       OCIOConfiguration;                                 // 0x00C0(0x00A8)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieGraphImageSequenceOutputNode) == 0x0001D8, "Wrong size on UMovieGraphImageSequenceOutputNode");
static_assert(offsetof(UMovieGraphImageSequenceOutputNode, OCIOConfiguration) == 0x0000C0, "Member 'UMovieGraphImageSequenceOutputNode::OCIOConfiguration' has a wrong offset!");
static_assert(offsetof(UMovieGraphImageSequenceOutputNode, OCIOContext) == 0x000168, "Member 'UMovieGraphImageSequenceOutputNode::OCIOContext' has a wrong offset!");
...
static_assert(sizeof(UMovieGraphImageSequenceOutputNode_EXR) == 0x0001E0, "Wrong size on UMovieGraphImageSequenceOutputNode_EXR");
static_assert(offsetof(UMovieGraphImageSequenceOutputNode_EXR, Compression) == 0x0001D9, "Member 'UMovieGraphImageSequenceOutputNode_EXR::Compression' has a wrong offset!");
...
static_assert(sizeof(UMovieGraphImageSequenceOutputNode_MultiLayerEXR) == 0x0001E0, "Wrong size on UMovieGraphImageSequenceOutputNode_MultiLayerEXR");
...
static_assert(sizeof(UMovieGraphImageSequenceOutputNode_BMP) == 0x0001D8, "Wrong size on UMovieGraphImageSequenceOutputNode_BMP");
...
static_assert(sizeof(UMovieGraphImageSequenceOutputNode_JPG) == 0x0001D8, "Wrong size on UMovieGraphImageSequenceOutputNode_JPG");
...
static_assert(sizeof(UMovieGraphImageSequenceOutputNode_PNG) == 0x0001D8, "Wrong size on UMovieGraphImageSequenceOutputNode_PNG");
...
public:
	uint8                                         bOverride_SpatialSampleCount : 1;                  // 0x00C0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bDenoiser : 1;                           // 0x00C0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bDisableToneCurve : 1;                   // 0x00C0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bAllowOCIO : 1;                          // 0x00C0(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bWriteAllSamples : 1;                    // 0x00C0(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_AdditionalPostProcessMaterials : 1;      // 0x00C0(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_C1[0x3];                                       // 0x00C1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         SpatialSampleCount;                                // 0x00C4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDenoiser;                                         // 0x00C8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bWriteAllSamples;                                  // 0x00C9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDisableToneCurve;                                 // 0x00CA(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowOCIO;                                        // 0x00CB(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieGraphPathTracerRenderPassNode) == 0x0000E8, "Wrong size on UMovieGraphPathTracerRenderPassNode");
static_assert(offsetof(UMovieGraphPathTracerRenderPassNode, SpatialSampleCount) == 0x0000C4, "Member 'UMovieGraphPathTracerRenderPassNode::SpatialSampleCount' has a wrong offset!");
static_assert(offsetof(UMovieGraphPathTracerRenderPassNode, bDenoiser) == 0x0000C8, "Member 'UMovieGraphPathTracerRenderPassNode::bDenoiser' has a wrong offset!");
static_assert(offsetof(UMovieGraphPathTracerRenderPassNode, bWriteAllSamples) == 0x0000C9, "Member 'UMovieGraphPathTracerRenderPassNode::bWriteAllSamples' has a wrong offset!");
static_assert(offsetof(UMovieGraphPathTracerRenderPassNode, bDisableToneCurve) == 0x0000CA, "Member 'UMovieGraphPathTracerRenderPassNode::bDisableToneCurve' has a wrong offset!");
static_assert(offsetof(UMovieGraphPathTracerRenderPassNode, bAllowOCIO) == 0x0000CB, "Member 'UMovieGraphPathTracerRenderPassNode::bAllowOCIO' has a wrong offset!");
static_assert(offsetof(UMovieGraphPathTracerRenderPassNode, AdditionalPostProcessMaterials) == 0x0000D0, "Member 'UMovieGraphPathTracerRenderPassNode::AdditionalPostProcessMaterials' has a wrong offset!");
