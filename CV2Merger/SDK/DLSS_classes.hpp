...
static_assert(offsetof(UDLSSSettings, DLAARRPreset) == 0x000061, "Member 'UDLSSSettings::DLAARRPreset' has a wrong offset!");
static_assert(offsetof(UDLSSSettings, DLSSRRQualityPreset) == 0x000063, "Member 'UDLSSSettings::DLSSRRQualityPreset' has a wrong offset!");
static_assert(offsetof(UDLSSSettings, DLSSRRBalancedPreset) == 0x000064, "Member 'UDLSSSettings::DLSSRRBalancedPreset' has a wrong offset!");
static_assert(offsetof(UDLSSSettings, DLSSRRPerformancePreset) == 0x000065, "Member 'UDLSSSettings::DLSSRRPerformancePreset' has a wrong offset!");
static_assert(offsetof(UDLSSSettings, DLSSRRUltraPerformancePreset) == 0x000066, "Member 'UDLSSSettings::DLSSRRUltraPerformancePreset' has a wrong offset!");
