...
public:
	...
	FMulticastInlineDelegateProperty_             K2_OnSearchFinished;                               // 0x0060(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UCommonSession_SearchSessionRequest) == 0x000070, "Wrong size on UCommonSession_SearchSessionRequest");
...
static_assert(offsetof(UCommonSession_SearchSessionRequest, K2_OnSearchFinished) == 0x000060, "Member 'UCommonSession_SearchSessionRequest::K2_OnSearchFinished' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             K2_OnUserRequestedSessionEvent;                    // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_60[0x20];                                      // 0x0060(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             K2_OnJoinSessionCompleteEvent;                     // 0x0080(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_90[0x20];                                      // 0x0090(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             K2_OnCreateSessionCompleteEvent;                   // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UCommonSessionSubsystem) == 0x000140, "Wrong size on UCommonSessionSubsystem");
static_assert(offsetof(UCommonSessionSubsystem, K2_OnUserRequestedSessionEvent) == 0x000050, "Member 'UCommonSessionSubsystem::K2_OnUserRequestedSessionEvent' has a wrong offset!");
static_assert(offsetof(UCommonSessionSubsystem, K2_OnJoinSessionCompleteEvent) == 0x000080, "Member 'UCommonSessionSubsystem::K2_OnJoinSessionCompleteEvent' has a wrong offset!");
static_assert(offsetof(UCommonSessionSubsystem, K2_OnCreateSessionCompleteEvent) == 0x0000B0, "Member 'UCommonSessionSubsystem::K2_OnCreateSessionCompleteEvent' has a wrong offset!");
