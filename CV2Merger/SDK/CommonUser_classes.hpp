...
public:
	...
	TMulticastInlineDelegate<void(bool bSucceeded, class FText ErrorMessage)> K2_OnSearchFinished;   // 0x0060(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
...
public:
	...
	TMulticastInlineDelegate<void(const struct FPlatformUserId& LocalPlatformUserId, class UCommonSession_SearchResult* RequestedSession, const struct FOnlineResultInformation& RequestedSessionResult)> K2_OnUserRequestedSessionEvent; // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_60[0x20];                                      // 0x0060(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(const struct FOnlineResultInformation& Result)> K2_OnJoinSessionCompleteEvent; // 0x0080(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_90[0x20];                                      // 0x0090(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(const struct FOnlineResultInformation& Result)> K2_OnCreateSessionCompleteEvent; // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
