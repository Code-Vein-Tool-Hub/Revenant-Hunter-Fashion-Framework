...
public:
	...
	void CalculateNiagaraTrailParameter(const struct FVector& InFirstSocketLocation, const struct FVector& InSecondSocketLocation, struct FVector* OutTrailLocation, struct FVector* OutTrailDirection, float* OutTrailWidth);
	...
	void SetEnableExecuteTrailTick(bool bEnable);
...
// Class Niagara.AppNiagaraComponent
// 0x0010 (0x0790 - 0x0780)
class UAppNiagaraComponent final : public UNiagaraComponent
{
public:
	bool                                          bEnableSlow;                                       // 0x0778(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bHiddenInSlow;                                     // 0x0779(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_77A[0x16];                                     // 0x077A(0x0016)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("AppNiagaraComponent")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"AppNiagaraComponent")
	}
	static class UAppNiagaraComponent* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAppNiagaraComponent>();
	}
};
DUMPER7_ASSERTS_UAppNiagaraComponent;

// Class Niagara.AppNiagaraComponentIF
// 0x0000 (0x0000 - 0x0000)
class IAppNiagaraComponentIF final
{
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("AppNiagaraComponentIF")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"AppNiagaraComponentIF")
	}
	static class IAppNiagaraComponentIF* GetDefaultObj()
	{
		return GetDefaultObjImpl<IAppNiagaraComponentIF>();
	}
...
DUMPER7_ASSERTS_IAppNiagaraComponentIF;
...
public:
	...
	struct FNiagaraDebugHUDSettingsData           Data;                                              // 0x0050(0x0250)(Edit, Config, NativeAccessSpecifierPublic)
...
{
public:
	class UNiagaraComponent*                      NiagaraComponent;                                  // 0x02A0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
{
public:
	class UNiagaraSystem*                         System;                                            // 0x02A0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	...
	class UNiagaraPreviewAxis*                    PreviewAxisX;                                      // 0x02B0(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	class UNiagaraPreviewAxis*                    PreviewAxisY;                                      // 0x02B8(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	...
	TArray<class UChildActorComponent*>           PreviewComponents;                                 // 0x02D8(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
...
{
public:
	class UNiagaraBaselineController*             Controller;                                        // 0x02A0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	class UTextRenderComponent*                   Label;                                             // 0x02A8(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
