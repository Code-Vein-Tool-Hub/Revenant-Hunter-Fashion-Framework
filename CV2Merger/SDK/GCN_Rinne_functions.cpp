...
#include "GCN_Rinne_classes.hpp"
#include "GCN_Rinne_parameters.hpp"
...
void UGCN_Rinne_C::OnBurst(class AActor* Target, const struct FGameplayCueParameters& Parameters, const struct FGameplayCueNotify_SpawnResult& SpawnResults) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Rinne_C", "OnBurst");

	Params::GCN_Rinne_C_OnBurst Parms{};
