...
// 0x0898 (0x0B20 - 0x0288)
class UControlRig : public URigVMHost
{
public:
	uint8                                         Pad_288[0x10];                                     // 0x0288(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	ERigExecutionType                             ExecutionType;                                     // 0x0298(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_299[0x3];                                      // 0x0299(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigHierarchySettings                  HierarchySettings;                                 // 0x029C(0x0004)(NoDestructor, NativeAccessSpecifierPublic)
	TMap<struct FRigElementKey, struct FRigControlElementCustomization> ControlCustomizations;                             // 0x02A0(0x0050)(Protected, NativeAccessSpecifierProtected)
	class URigHierarchy*                          DynamicHierarchy;                                  // 0x02F0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<TSoftObjectPtr<class UControlRigShapeLibrary>> ShapeLibraries;                                    // 0x02F8(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TMap<class FString, class FString>            ShapeLibraryNameMap;                               // 0x0308(0x0050)(Transient, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_358[0x10];                                     // 0x0358(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMExtendedExecuteContext           RigVMExtendedExecuteContext;                       // 0x0368(0x0230)(Transient, NativeAccessSpecifierPrivate)
	...
	TMap<class FName, class UDataAssetLink*>      ExternalVariableDataAssetLinks;                    // 0x07A0(0x0050)(ExportObject, Transient, DuplicateTransient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_7F0[0xF8];                                     // 0x07F0(0x00F8)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastSparseDelegateProperty_             OnControlSelected_BP;                              // 0x08E8(0x0001)(InstancedReference, BlueprintAssignable, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_8E9[0x17];                                     // 0x08E9(0x0017)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bIsAdditive;                                       // 0x0900(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_901[0x18F];                                    // 0x0901(0x018F)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigModuleSettings                     RigModuleSettings;                                 // 0x0A90(0x0080)(NativeAccessSpecifierPrivate)
	class FString                                 RigModuleNameSpace;                                // 0x0B10(0x0010)(ZeroConstructor, Transient, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UControlRig) == 0x000B20, "Wrong size on UControlRig");
static_assert(offsetof(UControlRig, ExecutionType) == 0x000298, "Member 'UControlRig::ExecutionType' has a wrong offset!");
static_assert(offsetof(UControlRig, HierarchySettings) == 0x00029C, "Member 'UControlRig::HierarchySettings' has a wrong offset!");
static_assert(offsetof(UControlRig, ControlCustomizations) == 0x0002A0, "Member 'UControlRig::ControlCustomizations' has a wrong offset!");
static_assert(offsetof(UControlRig, DynamicHierarchy) == 0x0002F0, "Member 'UControlRig::DynamicHierarchy' has a wrong offset!");
static_assert(offsetof(UControlRig, ShapeLibraries) == 0x0002F8, "Member 'UControlRig::ShapeLibraries' has a wrong offset!");
static_assert(offsetof(UControlRig, ShapeLibraryNameMap) == 0x000308, "Member 'UControlRig::ShapeLibraryNameMap' has a wrong offset!");
static_assert(offsetof(UControlRig, RigVMExtendedExecuteContext) == 0x000368, "Member 'UControlRig::RigVMExtendedExecuteContext' has a wrong offset!");
static_assert(offsetof(UControlRig, DataSourceRegistry) == 0x0005A0, "Member 'UControlRig::DataSourceRegistry' has a wrong offset!");
static_assert(offsetof(UControlRig, Influences) == 0x000688, "Member 'UControlRig::Influences' has a wrong offset!");
static_assert(offsetof(UControlRig, ExternalVariableDataAssetLinks) == 0x0007A0, "Member 'UControlRig::ExternalVariableDataAssetLinks' has a wrong offset!");
static_assert(offsetof(UControlRig, OnControlSelected_BP) == 0x0008E8, "Member 'UControlRig::OnControlSelected_BP' has a wrong offset!");
static_assert(offsetof(UControlRig, bIsAdditive) == 0x000900, "Member 'UControlRig::bIsAdditive' has a wrong offset!");
static_assert(offsetof(UControlRig, RigModuleSettings) == 0x000A90, "Member 'UControlRig::RigModuleSettings' has a wrong offset!");
static_assert(offsetof(UControlRig, RigModuleNameSpace) == 0x000B10, "Member 'UControlRig::RigModuleNameSpace' has a wrong offset!");

// Class ControlRig.ModularRig
// 0x0190 (0x0CB0 - 0x0B20)
class UModularRig final : public UControlRig
{
public:
	TArray<struct FRigModuleInstance>             Modules;                                           // 0x0B20(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_B30[0x20];                                     // 0x0B30(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	struct FModularRigSettings                    ModularRigSettings;                                // 0x0B50(0x0001)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_B51[0x7];                                      // 0x0B51(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FModularRigModel                       ModularRigModel;                                   // 0x0B58(0x00A0)(NativeAccessSpecifierPublic)
	TArray<struct FRigModuleExecutionElement>     ExecutionQueue;                                    // 0x0BF8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_C08[0xA8];                                     // 0x0C08(0x00A8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UModularRig) == 0x000CB0, "Wrong size on UModularRig");
static_assert(offsetof(UModularRig, Modules) == 0x000B20, "Member 'UModularRig::Modules' has a wrong offset!");
static_assert(offsetof(UModularRig, ModularRigSettings) == 0x000B50, "Member 'UModularRig::ModularRigSettings' has a wrong offset!");
static_assert(offsetof(UModularRig, ModularRigModel) == 0x000B58, "Member 'UModularRig::ModularRigModel' has a wrong offset!");
static_assert(offsetof(UModularRig, ExecutionQueue) == 0x000BF8, "Member 'UModularRig::ExecutionQueue' has a wrong offset!");
...
public:
	...
	uint32                                        MetadataVersion;                                   // 0x00BC(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint16                                        MetadataTagVersion;                                // 0x00C0(0x0002)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bEnableDirtyPropagation;                           // 0x00C2(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_C3[0x131];                                     // 0x00C3(0x0131)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         TransformStackIndex;                               // 0x01F4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1F8[0x80];                                     // 0x01F8(0x0080)(Fixing Size After Last Property [ Dumper-7 ])
	class URigHierarchyController*                HierarchyController;                               // 0x0278(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_280[0x8];                                      // 0x0280(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UModularRigRuleManager*                 RuleManager;                                       // 0x0288(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_290[0x50];                                     // 0x0290(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FRigElementKey, struct FRigElementKey> PreviousNameMap;                                   // 0x02E0(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_330[0xF8];                                     // 0x0330(0x00F8)(Fixing Size After Last Property [ Dumper-7 ])
	class URigHierarchy*                          HierarchyForCacheValidation;                       // 0x0428(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(URigHierarchy) == 0x0004F0, "Wrong size on URigHierarchy");
...
static_assert(offsetof(URigHierarchy, TopologyVersion) == 0x0000B8, "Member 'URigHierarchy::TopologyVersion' has a wrong offset!");
static_assert(offsetof(URigHierarchy, MetadataVersion) == 0x0000BC, "Member 'URigHierarchy::MetadataVersion' has a wrong offset!");
static_assert(offsetof(URigHierarchy, MetadataTagVersion) == 0x0000C0, "Member 'URigHierarchy::MetadataTagVersion' has a wrong offset!");
static_assert(offsetof(URigHierarchy, bEnableDirtyPropagation) == 0x0000C2, "Member 'URigHierarchy::bEnableDirtyPropagation' has a wrong offset!");
static_assert(offsetof(URigHierarchy, TransformStackIndex) == 0x0001F4, "Member 'URigHierarchy::TransformStackIndex' has a wrong offset!");
static_assert(offsetof(URigHierarchy, HierarchyController) == 0x000278, "Member 'URigHierarchy::HierarchyController' has a wrong offset!");
static_assert(offsetof(URigHierarchy, RuleManager) == 0x000288, "Member 'URigHierarchy::RuleManager' has a wrong offset!");
static_assert(offsetof(URigHierarchy, PreviousNameMap) == 0x0002E0, "Member 'URigHierarchy::PreviousNameMap' has a wrong offset!");
static_assert(offsetof(URigHierarchy, HierarchyForCacheValidation) == 0x000428, "Member 'URigHierarchy::HierarchyForCacheValidation' has a wrong offset!");
...
static_assert(sizeof(UTransformableControlHandle) == 0x000098, "Wrong size on UTransformableControlHandle");
static_assert(offsetof(UTransformableControlHandle, ControlRig) == 0x000068, "Member 'UTransformableControlHandle::ControlRig' has a wrong offset!");
...
static_assert(sizeof(UModularRigController) == 0x000058, "Wrong size on UModularRigController");
...
static_assert(sizeof(UAdditiveControlRig) == 0x000B30, "Wrong size on UAdditiveControlRig");
...
{
public:
	TArray<bool>                                  IsControlActive;                                   // 0x0B20(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	EControlRigFKRigExecuteMode                   ApplyMode;                                         // 0x0B30(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_B31[0x2F];                                     // 0x0B31(0x002F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UFKControlRig) == 0x000B60, "Wrong size on UFKControlRig");
static_assert(offsetof(UFKControlRig, IsControlActive) == 0x000B20, "Member 'UFKControlRig::IsControlActive' has a wrong offset!");
static_assert(offsetof(UFKControlRig, ApplyMode) == 0x000B30, "Member 'UFKControlRig::ApplyMode' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneControlRigParameterSection) == 0x000400, "Wrong size on UMovieSceneControlRigParameterSection");
...
static_assert(offsetof(UMovieSceneControlRigParameterSection, ControlChannelMap) == 0x000308, "Member 'UMovieSceneControlRigParameterSection::ControlChannelMap' has a wrong offset!");
static_assert(offsetof(UMovieSceneControlRigParameterSection, EnumParameterNamesAndCurves) == 0x000358, "Member 'UMovieSceneControlRigParameterSection::EnumParameterNamesAndCurves' has a wrong offset!");
static_assert(offsetof(UMovieSceneControlRigParameterSection, IntegerParameterNamesAndCurves) == 0x000368, "Member 'UMovieSceneControlRigParameterSection::IntegerParameterNamesAndCurves' has a wrong offset!");
static_assert(offsetof(UMovieSceneControlRigParameterSection, SpaceChannels) == 0x000378, "Member 'UMovieSceneControlRigParameterSection::SpaceChannels' has a wrong offset!");
static_assert(offsetof(UMovieSceneControlRigParameterSection, ConstraintsChannels) == 0x000388, "Member 'UMovieSceneControlRigParameterSection::ConstraintsChannels' has a wrong offset!");
...
public:
	...
	int32                                         PriorityOrder;                                     // 0x0168(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_16C[0x4];                                      // 0x016C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<TWeakObjectPtr<class UWorld>, class UControlRig*> GameWorldControlRigs;                              // 0x0170(0x0050)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneControlRigParameterTrack) == 0x0001C0, "Wrong size on UMovieSceneControlRigParameterTrack");
static_assert(offsetof(UMovieSceneControlRigParameterTrack, ControlRig) == 0x0000F0, "Member 'UMovieSceneControlRigParameterTrack::ControlRig' has a wrong offset!");
static_assert(offsetof(UMovieSceneControlRigParameterTrack, SectionToKey) == 0x0000F8, "Member 'UMovieSceneControlRigParameterTrack::SectionToKey' has a wrong offset!");
static_assert(offsetof(UMovieSceneControlRigParameterTrack, Sections) == 0x000100, "Member 'UMovieSceneControlRigParameterTrack::Sections' has a wrong offset!");
static_assert(offsetof(UMovieSceneControlRigParameterTrack, TrackName) == 0x000110, "Member 'UMovieSceneControlRigParameterTrack::TrackName' has a wrong offset!");
static_assert(offsetof(UMovieSceneControlRigParameterTrack, ControlsRotationOrder) == 0x000118, "Member 'UMovieSceneControlRigParameterTrack::ControlsRotationOrder' has a wrong offset!");
static_assert(offsetof(UMovieSceneControlRigParameterTrack, PriorityOrder) == 0x000168, "Member 'UMovieSceneControlRigParameterTrack::PriorityOrder' has a wrong offset!");
static_assert(offsetof(UMovieSceneControlRigParameterTrack, GameWorldControlRigs) == 0x000170, "Member 'UMovieSceneControlRigParameterTrack::GameWorldControlRigs' has a wrong offset!");
