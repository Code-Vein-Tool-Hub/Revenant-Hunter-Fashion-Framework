...
static_assert(sizeof(UPolyEditExtrudeEdgeActivityProperties) == 0x0000C8, "Wrong size on UPolyEditExtrudeEdgeActivityProperties");
static_assert(offsetof(UPolyEditExtrudeEdgeActivityProperties, DirectionMode) == 0x0000B0, "Member 'UPolyEditExtrudeEdgeActivityProperties::DirectionMode' has a wrong offset!");
static_assert(offsetof(UPolyEditExtrudeEdgeActivityProperties, DistanceMode) == 0x0000B4, "Member 'UPolyEditExtrudeEdgeActivityProperties::DistanceMode' has a wrong offset!");
static_assert(offsetof(UPolyEditExtrudeEdgeActivityProperties, Distance) == 0x0000B8, "Member 'UPolyEditExtrudeEdgeActivityProperties::Distance' has a wrong offset!");
static_assert(offsetof(UPolyEditExtrudeEdgeActivityProperties, bUseUnselectedForFrames) == 0x0000C0, "Member 'UPolyEditExtrudeEdgeActivityProperties::bUseUnselectedForFrames' has a wrong offset!");
static_assert(offsetof(UPolyEditExtrudeEdgeActivityProperties, bAdjustToExtrudeEvenly) == 0x0000C1, "Member 'UPolyEditExtrudeEdgeActivityProperties::bAdjustToExtrudeEvenly' has a wrong offset!");
...
{
public:
	class UCSGMeshesToolProperties*               CSGProperties;                                     // 0x0118(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UTrimMeshesToolProperties*              TrimProperties;                                    // 0x0120(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_128[0x10];                                     // 0x0128(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UPreviewMesh*>                   OriginalMeshPreviews;                              // 0x0138(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class UMaterialInstanceDynamic*               PreviewsGhostMaterial;                             // 0x0148(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class ULineSetComponent*                      DrawnLineSet;                                      // 0x0150(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCSGMeshesTool) == 0x000170, "Wrong size on UCSGMeshesTool");
static_assert(offsetof(UCSGMeshesTool, CSGProperties) == 0x000118, "Member 'UCSGMeshesTool::CSGProperties' has a wrong offset!");
static_assert(offsetof(UCSGMeshesTool, TrimProperties) == 0x000120, "Member 'UCSGMeshesTool::TrimProperties' has a wrong offset!");
static_assert(offsetof(UCSGMeshesTool, OriginalMeshPreviews) == 0x000138, "Member 'UCSGMeshesTool::OriginalMeshPreviews' has a wrong offset!");
static_assert(offsetof(UCSGMeshesTool, PreviewsGhostMaterial) == 0x000148, "Member 'UCSGMeshesTool::PreviewsGhostMaterial' has a wrong offset!");
static_assert(offsetof(UCSGMeshesTool, DrawnLineSet) == 0x000150, "Member 'UCSGMeshesTool::DrawnLineSet' has a wrong offset!");
...
{
public:
	class UCutMeshWithMeshToolProperties*         CutProperties;                                     // 0x0118(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPreviewMesh*                           IntersectPreviewMesh;                              // 0x0120(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCutMeshWithMeshTool) == 0x000390, "Wrong size on UCutMeshWithMeshTool");
static_assert(offsetof(UCutMeshWithMeshTool, CutProperties) == 0x000118, "Member 'UCutMeshWithMeshTool::CutProperties' has a wrong offset!");
static_assert(offsetof(UCutMeshWithMeshTool, IntersectPreviewMesh) == 0x000120, "Member 'UCutMeshWithMeshTool::IntersectPreviewMesh' has a wrong offset!");
static_assert(offsetof(UCutMeshWithMeshTool, DrawnLineSet) == 0x000148, "Member 'UCutMeshWithMeshTool::DrawnLineSet' has a wrong offset!");
...
public:
	...
	class UPolyEditTopologyProperties*            TopologyProperties;                                // 0x0188(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPolyEditExtrudeActivity*               ExtrudeActivity;                                   // 0x0190(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPolyEditInsetOutsetActivity*           InsetOutsetActivity;                               // 0x0198(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPolyEditCutFacesActivity*              CutFacesActivity;                                  // 0x01A0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPolyEditPlanarProjectionUVActivity*    PlanarProjectionUVActivity;                        // 0x01A8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPolyEditInsertEdgeActivity*            InsertEdgeActivity;                                // 0x01B0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPolyEditInsertEdgeLoopActivity*        InsertEdgeLoopActivity;                            // 0x01B8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPolyEditBevelEdgeActivity*             BevelEdgeActivity;                                 // 0x01C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPolyEditExtrudeEdgeActivity*           ExtrudeEdgeActivity;                               // 0x01C8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1D0[0xD8];                                     // 0x01D0(0x00D8)(Fixing Size After Last Property [ Dumper-7 ])
	class UPolyEditActivityContext*               ActivityContext;                                   // 0x02A8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPolygonSelectionMechanic*              SelectionMechanic;                                 // 0x02B0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UDragAlignmentMechanic*                 DragAlignmentMechanic;                             // 0x02B8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCombinedTransformGizmo*                TransformGizmo;                                    // 0x02C0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UTransformProxy*                        TransformProxy;                                    // 0x02C8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2D0[0x640];                                    // 0x02D0(0x0640)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UEditMeshPolygonsTool) == 0x000910, "Wrong size on UEditMeshPolygonsTool");
...
static_assert(offsetof(UEditMeshPolygonsTool, TopologyProperties) == 0x000188, "Member 'UEditMeshPolygonsTool::TopologyProperties' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, ExtrudeActivity) == 0x000190, "Member 'UEditMeshPolygonsTool::ExtrudeActivity' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, InsetOutsetActivity) == 0x000198, "Member 'UEditMeshPolygonsTool::InsetOutsetActivity' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, CutFacesActivity) == 0x0001A0, "Member 'UEditMeshPolygonsTool::CutFacesActivity' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, PlanarProjectionUVActivity) == 0x0001A8, "Member 'UEditMeshPolygonsTool::PlanarProjectionUVActivity' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, InsertEdgeActivity) == 0x0001B0, "Member 'UEditMeshPolygonsTool::InsertEdgeActivity' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, InsertEdgeLoopActivity) == 0x0001B8, "Member 'UEditMeshPolygonsTool::InsertEdgeLoopActivity' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, BevelEdgeActivity) == 0x0001C0, "Member 'UEditMeshPolygonsTool::BevelEdgeActivity' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, ExtrudeEdgeActivity) == 0x0001C8, "Member 'UEditMeshPolygonsTool::ExtrudeEdgeActivity' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, ActivityContext) == 0x0002A8, "Member 'UEditMeshPolygonsTool::ActivityContext' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, SelectionMechanic) == 0x0002B0, "Member 'UEditMeshPolygonsTool::SelectionMechanic' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, DragAlignmentMechanic) == 0x0002B8, "Member 'UEditMeshPolygonsTool::DragAlignmentMechanic' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, TransformGizmo) == 0x0002C0, "Member 'UEditMeshPolygonsTool::TransformGizmo' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, TransformProxy) == 0x0002C8, "Member 'UEditMeshPolygonsTool::TransformProxy' has a wrong offset!");
...
static_assert(sizeof(UPolyEditBevelEdgeProperties) == 0x0000C8, "Wrong size on UPolyEditBevelEdgeProperties");
...
static_assert(offsetof(UPolyEditBevelEdgeProperties, Subdivisions) == 0x0000B8, "Member 'UPolyEditBevelEdgeProperties::Subdivisions' has a wrong offset!");
static_assert(offsetof(UPolyEditBevelEdgeProperties, RoundWeight) == 0x0000BC, "Member 'UPolyEditBevelEdgeProperties::RoundWeight' has a wrong offset!");
static_assert(offsetof(UPolyEditBevelEdgeProperties, bInferMaterialID) == 0x0000C0, "Member 'UPolyEditBevelEdgeProperties::bInferMaterialID' has a wrong offset!");
static_assert(offsetof(UPolyEditBevelEdgeProperties, SetMaterialID) == 0x0000C4, "Member 'UPolyEditBevelEdgeProperties::SetMaterialID' has a wrong offset!");
...
static_assert(offsetof(UPolyEditExtrudeProperties, DirectionMode) == 0x0000C0, "Member 'UPolyEditExtrudeProperties::DirectionMode' has a wrong offset!");
static_assert(offsetof(UPolyEditExtrudeProperties, Direction) == 0x0000C4, "Member 'UPolyEditExtrudeProperties::Direction' has a wrong offset!");
...
static_assert(offsetof(UPolyEditExtrudeProperties, bShellsToSolids) == 0x0000D0, "Member 'UPolyEditExtrudeProperties::bShellsToSolids' has a wrong offset!");
static_assert(offsetof(UPolyEditExtrudeProperties, MeasureDirection) == 0x0000D4, "Member 'UPolyEditExtrudeProperties::MeasureDirection' has a wrong offset!");
...
static_assert(offsetof(UPolyEditPushPullProperties, SingleDirection) == 0x0000C4, "Member 'UPolyEditPushPullProperties::SingleDirection' has a wrong offset!");
...
public:
	uint8                                         Pad_C8[0x8];                                       // 0x00C8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UMeshUVChannelProperties*               UVChannelProperties;                               // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UUVLayoutProperties*                    BasicProperties;                                   // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UExistingMeshMaterialProperties*        MaterialSettings;                                  // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UMeshOpPreviewWithBackgroundCompute*> Previews;                                          // 0x00E8(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class UUVLayoutOperatorFactory*>       Factories;                                         // 0x00F8(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UUVLayoutTool) == 0x000180, "Wrong size on UUVLayoutTool");
static_assert(offsetof(UUVLayoutTool, UVChannelProperties) == 0x0000D0, "Member 'UUVLayoutTool::UVChannelProperties' has a wrong offset!");
static_assert(offsetof(UUVLayoutTool, BasicProperties) == 0x0000D8, "Member 'UUVLayoutTool::BasicProperties' has a wrong offset!");
static_assert(offsetof(UUVLayoutTool, MaterialSettings) == 0x0000E0, "Member 'UUVLayoutTool::MaterialSettings' has a wrong offset!");
static_assert(offsetof(UUVLayoutTool, Previews) == 0x0000E8, "Member 'UUVLayoutTool::Previews' has a wrong offset!");
static_assert(offsetof(UUVLayoutTool, Factories) == 0x0000F8, "Member 'UUVLayoutTool::Factories' has a wrong offset!");
static_assert(offsetof(UUVLayoutTool, UVLayoutView) == 0x000170, "Member 'UUVLayoutTool::UVLayoutView' has a wrong offset!");
