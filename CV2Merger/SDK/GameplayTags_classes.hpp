...
public:
	...
	TMap<class FName, struct FGameplayTagSource>  TagSources;                                        // 0x0190(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_1E0[0xB8];                                     // 0x01E0(0x00B8)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UDataTable*>                     GameplayTagTables;                                 // 0x0298(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UGameplayTagsManager) == 0x0002A8, "Wrong size on UGameplayTagsManager");
static_assert(offsetof(UGameplayTagsManager, TagSources) == 0x000190, "Member 'UGameplayTagsManager::TagSources' has a wrong offset!");
static_assert(offsetof(UGameplayTagsManager, GameplayTagTables) == 0x000298, "Member 'UGameplayTagsManager::GameplayTagTables' has a wrong offset!");
