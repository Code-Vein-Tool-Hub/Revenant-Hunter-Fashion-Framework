...
static_assert(sizeof(UMediaPlayer) == 0x000170, "Wrong size on UMediaPlayer");
...
static_assert(offsetof(UMediaPlayer, PlayerGuid) == 0x000148, "Member 'UMediaPlayer::PlayerGuid' has a wrong offset!");
...
static_assert(sizeof(UMediaSoundComponent) == 0x000980, "Wrong size on UMediaSoundComponent");
static_assert(offsetof(UMediaSoundComponent, Channels) == 0x0008A0, "Member 'UMediaSoundComponent::Channels' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, DynamicRateAdjustment) == 0x0008A4, "Member 'UMediaSoundComponent::DynamicRateAdjustment' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, RateAdjustmentFactor) == 0x0008A8, "Member 'UMediaSoundComponent::RateAdjustmentFactor' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, RateAdjustmentRange) == 0x0008AC, "Member 'UMediaSoundComponent::RateAdjustmentRange' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, MediaPlayer) == 0x0008C0, "Member 'UMediaSoundComponent::MediaPlayer' has a wrong offset!");
